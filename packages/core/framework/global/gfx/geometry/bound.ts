import { EPSILON, lineIntersects, polygonPointDistance } from '../math';
import type { SerializedXYWH, XYWH } from '../xywh';
import { deserializeXYWH, serializeXYWH } from '../xywh';
import { type IVec, Vec } from './vec';
