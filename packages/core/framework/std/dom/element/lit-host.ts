import {
  ...
  ErrorCode,
  handleError,
} from '@linvo-core/global/exceptions';
...
import type { UIEventDispatcher } from '../../event';
import { WidgetViewIdentifier } from '../../identifier';
import type { RangeManager } from '../../inline';
import type { BlockStdScope } from '../../scope/std-scope';
import { PropTypes, requiredProperties } from '../decorators';
import type { ViewStore } from '../view-store';
import { BLOCK_ID_ATTR, WIDGET_ID_ATTR } from './consts';
import { ShadowlessElement } from './shadowless-element';
