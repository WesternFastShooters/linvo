...
import { Bound, clamp, Point } from '@linvo-core/global/gfx';
import { signal } from '@preact/signals-core';
import last from 'lodash-es/last.js';

import type { PointerEventState } from '../../event/state/pointer';
import { getTopElements } from '../../utils/tree';
import type { GfxBlockComponent } from '../../dom';
...
import { createInteractionContext, type SupportedEvents } from './event';
import {
...
import { GfxViewEventManager } from './gfx-view-event-handler';
import {
  DEFAULT_HANDLES,
  type OptionResize,
  ResizeController,
...
import type { RequestElementsCloneContext } from './types/clone';
import type {
