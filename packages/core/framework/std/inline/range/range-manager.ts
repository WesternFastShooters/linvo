...
import type { BlockComponent } from '../../dom/element/block-component';
import { BLOCK_ID_ATTR } from '../../dom';
import { INLINE_ROOT_ATTR } from '../consts';
import type { InlineRootElement } from '../inline-editor';
import { RANGE_QUERY_EXCLUDE_ATTR, RANGE_SYNC_EXCLUDE_ATTR } from './consts';
import { RangeBinding } from './range-binding';
