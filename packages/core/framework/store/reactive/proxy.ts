...
import type { YArrayEvent, YMapEvent } from '../compat';
import { Array as YArray, Map as YMap } from '../compat';
...
import type { ProxyOptions, TransformOptions, UnRecord } from './types';
