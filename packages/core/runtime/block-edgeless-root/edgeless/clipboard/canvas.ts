...
import type { Connection } from '@linvo-core/content';
import { TelemetryProvider } from '@linvo-core/shared/services';
import { Bound, type SerializedXYWH, Vec } from '@linvo-core/global/gfx';
...
export function createCanvasElement(
  ...
  if (clipboardData.type === GROUP) {
    ...
    for (const [key, value] of Object.entries(children)) {
      ...
      nextChildren[newKey] = value;
    }
    clipboardData.children = nextChildren;
