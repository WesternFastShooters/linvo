...
import type { FrameBlockProps } from '@linvo-core/content';
import { encodeClipboardBlobs } from '@linvo-core/shared/adapters';
import { Bound, getBoundWithRotation } from '@linvo-core/global/gfx';
...
import { type BlockSnapshot, BlockSnapshotSchema } from '@linvo-core/store';
...
export function createNewPresentationIndexes(
  ...
  const frames = raw
    .filter((block): block is FrameSnapshot => {
      ...
      return data?.flavour === 'linvo:frame';
    })
