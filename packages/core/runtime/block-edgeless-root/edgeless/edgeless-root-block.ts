...
import { isSingleMindMapNode } from '@linvo-primitives/mindmap';
import { PanTool } from '@linvo-primitives/pointer';
import { mountShapeTextEditor } from '@linvo-primitives/shape';
import {
  type RootBlockModel,
...
import { IS_WINDOWS } from '@linvo-core/global/env';
import { Bound, Point, Vec } from '@linvo-core/global/gfx';
import {
  BlockComponent,
...
import { EdgelessPageKeyboardManager } from './edgeless-keyboard';
import type { EdgelessRootService } from './edgeless-root-service';
...
> {
  ...
  get surfaceBlockModel() {
    return this.model.children.find(
      child => child.flavour === 'linvo:surface'
