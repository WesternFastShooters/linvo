...
import { FeatureFlagService } from '@linvo-core/shared/services';
import { requestConnectedFrame } from '@linvo-core/shared/utils';
...
import type { SurfaceElementModel } from '../element-model/base';
import type { DomElementRenderer } from './dom-elements';
import { DomElementRendererIdentifier } from './dom-elements';
 ...
 *     Example: `shapeDomRenderer` in `packages/gfx/shape/src/element-renderer/shape-dom/index.ts`.
 ...
 *     Import `DomElementRendererExtension` (e.g., from `@linvo-core/block-surface` or its source location
 *     `packages/blocks/surface/src/extensions/dom-element-renderer.ts`).
 ...
 *     Example: `ShapeDomRendererExtension` in `packages/gfx/shape/src/element-renderer/shape-dom.ts`.
 *
 * 3.  **Register the Extension**:
 *     In your application setup where editor services and view extensions are registered (e.g., a `ViewExtensionProvider`
 ...
 *     As seen with `ShapeDomRendererExtension` being registered in `packages/gfx/shape/src/view.ts`.
 *
 ...
 *         `packages/blocks/surface/src/renderer/dom-elements/index.ts`.
 ...
 *         (e.g., from `@linvo-core/block-surface` or its source).
 ...
 *
 * 5.  **Ensure Exports**:
 *     -   The `DomRenderer` class itself should be accessible (e.g., exported from `@linvo-core/block-surface`).
