...
import type { BlockMeta } from '../../helpers';
...
export declare const AttachmentBlockSchema: {
    version: number;
    model: {
        props: import("@linvo-core/store").PropsGetter<AttachmentBlockProps>;
...
export declare const AttachmentBlockSchemaExtension: import("@linvo-core/composition").ExtensionType;
declare const AttachmentBlockModel_base: {
    new (): import("@linvo-core/std/gfx").GfxBlockElementModel<AttachmentBlockProps>;
};
