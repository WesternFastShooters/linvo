...
(function (NoteShadow) {
    NoteShadow["Box"] = "--linvo-note-shadow-box";
    NoteShadow["Film"] = "--linvo-note-shadow-film";
    NoteShadow["Float"] = "--linvo-note-shadow-float";
    NoteShadow["None"] = "";
    NoteShadow["Paper"] = "--linvo-note-shadow-paper";
    NoteShadow["Sticker"] = "--linvo-note-shadow-sticker";
