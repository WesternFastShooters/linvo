import type { IVec, SerializedXYWH, XYWH } from '@linvo-core/global/gfx';
import { Bound, PointLocation } from '@linvo-core/global/gfx';
import type { BaseElementProps, PointTestOptions, SerializedElement } from '@linvo-core/std/gfx';
import { GfxPrimitiveElementModel } from '@linvo-core/std/gfx';
import { PlainText } from '@linvo-core/store/reactive/text';
import { ConnectorLabelOffsetAnchor, ConnectorMode, type PointStyle, StrokeStyle, type TextStyleProps } from '../../definitions';
