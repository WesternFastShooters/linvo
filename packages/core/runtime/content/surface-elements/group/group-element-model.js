...
import { canSafeAddToContainer, ElementDataMap, field, GfxGroupLikeElementModel, local, observe, } from '@linvo-core/std/gfx';
    ...
    return class GroupElementModel extends _classSuper {
        ...
        static propsToY(props) {
            if (typeof props.title === 'string') {
                props.title = new PlainText(props.title);
            }
        ...
        accessor children = __runInitializers(this, _children_initializers, new ElementDataMap());
        accessor showTitle = (__runInitializers(this, _children_extraInitializers), __runInitializers(this, _showTitle_initializers, true));
        accessor title = (__runInitializers(this, _showTitle_extraInitializers), __runInitializers(this, _title_initializers, new PlainText()));
        constructor() {
            super(...arguments);
