...
import { Bound, getBoundFromPoints, getPointsFromBoundWithRotation, getQuadBoundWithRotation, getSolidStrokePoints, getSvgPathFromStroke, inflateBound, isPointOnlines, lineIntersects, PointLocation, polyLineNearestPoint, transformPointsToNewBound, Vec, } from '@linvo-core/global/gfx';
import { convert, derive, field, GfxPrimitiveElementModel, watch, } from '@linvo-core/std/gfx';
import { DEFAULT_HIGHLIGHTER_LINE_WIDTH } from '../../definitions';
...
let HighlighterElementModel = (() => {
    ...
    return class HighlighterElementModel extends _classSuper {
        ...
        accessor color = __runInitializers(this, _color_initializers, DefaultTheme.hightlighterColor);
        accessor lineWidth = (__runInitializers(this, _color_extraInitializers), __runInitializers(this, _lineWidth_initializers, DEFAULT_HIGHLIGHTER_LINE_WIDTH));
        accessor points = (__runInitializers(this, _lineWidth_extraInitializers), __runInitializers(this, _points_initializers, []));
        accessor rotate = (__runInitializers(this, _points_extraInitializers), __runInitializers(this, _rotate_initializers, 0));
        accessor xywh = (__runInitializers(this, _rotate_extraInitializers), __runInitializers(this, _xywh_initializers, '[0,0,0,0]'));
        constructor() {
            super(...arguments);
