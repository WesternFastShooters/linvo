...
import { convert, ElementDataMap, field, GfxGroupLikeElementModel, observe, watch, } from '@linvo-core/std/gfx';
    ...
    return class MindmapElementModel extends _classSuper {
        ...
        parent, sibling, position = 'after', props = {}) {
            ...
            if (typeof props.text === 'string' || !props.text) {
                props['text'] = new PlainText(props['text'] ?? 'New node');
            }
        ...
        constructor() {
            ...
            this.#children_accessor_storage = __runInitializers(this, _children_initializers, new ElementDataMap());
