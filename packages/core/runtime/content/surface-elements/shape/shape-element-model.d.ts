import type { Bound, IBound, IVec, PointLocation, SerializedXYWH } from '@linvo-core/global/gfx';
import type { BaseElementProps, PointTestOptions } from '@linvo-core/std/gfx';
import { GfxLocalElementModel, GfxPrimitiveElementModel } from '@linvo-core/std/gfx';
import { PlainText } from '@linvo-core/store/reactive/text';
import { FontStyle, FontWeight, ShapeStyle, ShapeType, StrokeStyle, TextAlign, TextResizing, type TextStyleProps, TextVerticalAlign } from '../../definitions';
...
export declare class ShapeElementModel extends GfxPrimitiveElementModel<ShapeProps> {
    ...
    accessor text: PlainText | undefined;
