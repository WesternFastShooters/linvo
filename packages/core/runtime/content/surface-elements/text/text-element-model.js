...
import { Bound, getPointsFromBoundWithRotation, linePolygonIntersects, pointInPolygon, polygonNearestPoint, } from '@linvo-core/global/gfx';
import { field, GfxPrimitiveElementModel } from '@linvo-core/std/gfx';
import { PlainText } from '@linvo-core/store/reactive/text';
import { FontFamily, FontStyle, FontWeight, TextAlign, } from '../../definitions';
...
let TextElementModel = (() => {
    ...
    return class TextElementModel extends _classSuper {
        ...
        accessor color = __runInitializers(this, _color_initializers, DefaultTheme.black);
        accessor fontFamily = (__runInitializers(this, _color_extraInitializers), __runInitializers(this, _fontFamily_initializers, FontFamily.Inter));
        accessor fontSize = (__runInitializers(this, _fontFamily_extraInitializers), __runInitializers(this, _fontSize_initializers, 16));
        accessor fontStyle = (__runInitializers(this, _fontSize_extraInitializers), __runInitializers(this, _fontStyle_initializers, FontStyle.Normal));
        accessor fontWeight = (__runInitializers(this, _fontStyle_extraInitializers), __runInitializers(this, _fontWeight_initializers, FontWeight.Regular));
        accessor hasMaxWidth = (__runInitializers(this, _fontWeight_extraInitializers), __runInitializers(this, _hasMaxWidth_initializers, false));
        accessor rotate = (__runInitializers(this, _hasMaxWidth_extraInitializers), __runInitializers(this, _rotate_initializers, 0));
        accessor text = (__runInitializers(this, _rotate_extraInitializers), __runInitializers(this, _text_initializers, new PlainText()));
        accessor textAlign = (__runInitializers(this, _text_extraInitializers), __runInitializers(this, _textAlign_initializers, TextAlign.Center));
        accessor xywh = (__runInitializers(this, _textAlign_extraInitializers), __runInitializers(this, _xywh_initializers, '[0,0,16,16]'));
        constructor() {
            super(...arguments);
