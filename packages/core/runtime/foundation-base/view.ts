import { FileDropExtension } from '@linvo-ui/components/drop-indicator';
import {
  PeekViewExtension,
  type PeekViewService,
} from '@linvo-ui/components/peek';
import {
...
import { InteractivityManager, ToolController } from '@linvo-core/std/gfx';
import { z } from 'zod';
