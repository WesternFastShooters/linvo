...
import type { DisposableMember } from '@linvo-core/global/disposable';
import type { BaseSelection, ExtensionType } from '@linvo-core/store';
 ...
 * In essence, it follows the flow: editor model -> product service -> editor model.
 */
