...
import { Extension, Slice, type SliceSnapshot } from '@linvo-core/store';
...
export class DNDAPIExtension extends Extension {
  ...
  fromEntity(options: {
    ...
    const { docId, flavour = 'linvo:embed-iframe', blockId } = options;
    ...
    return {
      ...
      content: [
        {
          id: this.std.docSource.idGenerator(),
          type: 'block',
          flavour,
          props,
          children: [],
