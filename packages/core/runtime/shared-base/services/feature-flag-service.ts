import { type Store, StoreExtension } from '@linvo-core/store';
import { type Signal, signal } from '@preact/signals-core';

export interface LinvoFlags {
...
export class FeatureFlagService extends StoreExtension {
  ...
  private readonly _flags: Signal<LinvoFlags> = signal({
  ...
  setFlag(key: keyof LinvoFlags, value: boolean) {
    this._flags.value = {
      ...this._flags.value,
      [key]: value,
    };
