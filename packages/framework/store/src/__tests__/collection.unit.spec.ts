...
describe('addBlock', () => {
  ...
  it('can add multi models', () => {
    ...
    doc.addBlocks(
      [
        { flavour: 'linvo:paragraph', blockProps: { type: 'h1' } },
        { flavour: 'linvo:paragraph', blockProps: { type: 'h2' } },
      ],
      noteId
    );
  ...
  it('can observe slot events', async () => {
    ...
    assert.equal(block.flavour, 'linvo:page');
  });
  ...
  it('can add block to root', async () => {
    ...
    assert.equal(root.flavour, 'linvo:page');
...
describe('deleteBlock', () => {
  ...
  it('bring children to parent', () => {
    ...
    const rootId = doc.addBlock('linvo:page', {});
    const noteId = doc.addBlock('linvo:note', {}, rootId);
    const p1 = doc.addBlock('linvo:paragraph', {}, noteId);
  ...
  it('bring children to other block', () => {
    ...
    const noteId = doc.addBlock('linvo:note', {}, rootId);
    const p1 = doc.addBlock('linvo:paragraph', {}, noteId);
    const p2 = doc.addBlock('linvo:paragraph', {}, noteId);
    doc.addBlock('linvo:paragraph', {}, p1);
    doc.addBlock('linvo:paragraph', {}, p1);
...
describe('getBlock', () => {
  it('can get block by id', () => {
    ...
    assert.equal(text.flavour, 'linvo:paragraph');
