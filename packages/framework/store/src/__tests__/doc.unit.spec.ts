...
test('query', () => {
  ...
  const page = store1.addBlock('linvo:page');
  const note = store1.addBlock('linvo:note', {}, page);
  const paragraph1 = store1.addBlock('linvo:paragraph', {}, note);
  const list1 = store1.addBlock('linvo:list' as never, {}, note);
  ...
  const list2 = store1.addBlock('linvo:list' as never, {}, note);
