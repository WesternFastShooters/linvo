...
import { NotionHtmlAdapter } from '@linvo/linvo-shared/adapters';
import { DEFAULT_IMAGE_PROXY_ENDPOINT } from '@linvo/linvo-shared/consts';
import {
  AssetsManager,
  type BlockSnapshot,
  MemoryBlobCRUD,
...
describe('notion html to snapshot', () => {
  ...
  describe('image', () => {
    const originalUrl =
      'https://raw.githubusercontent.com/toeverything/linvo/master/assets/logo.svg';
  ...
  test('bookmark', async () => {
    const html = `<div class="page-body">
      <figure id="ed3d2ae9-62f5-433a-9049-9ddbd1c81ac5"><a href="https://linvo.pro/" class="bookmark source">
          <div class="bookmark-info">
            <div class="bookmark-text">
              <div class="bookmark-title">Linvo - Visual Collaboration Workspace</div>
              <div class="bookmark-description">The universal editor that lets you work, play, present or
                create just about anything.</div>
            </div>
            <div class="bookmark-href"><img src="https://linvo.pro/favicon-96.png"
                class="icon bookmark-icon" />https://linvo.pro/</div>
          </div><img src="https://linvo.pro/og.png" class="bookmark-image" />
        </a></figure>
    </div>`;
          ...
          <tbody>
            <tr id="ed3d2ae9-62f5-433a-9049-9ddbd1c81ac5">
              <td class="cell-title"><a
                  href="https://www.notion.so/https-linvo-pro-ed3d2ae962f5433a90499ddbd1c81ac5?pvs=21">https://linvo.pro</a>
              </td>
          ...
          children: [
            {
              ...
              props: {
                text: {
                  ...
                  delta: [
                    {
                      insert: 'https://linvo.pro',
                      attributes: {
                        link: 'https://www.notion.so/https-linvo-pro-ed3d2ae962f5433a90499ddbd1c81ac5?pvs=21',
                      },
                    },
                  ],
                },
