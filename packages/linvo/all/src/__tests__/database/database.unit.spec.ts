...
describe('DatabaseManager', () => {
  ...
  const selection = [
    { id: '1', value: 'Done', color: 'var(--linvo-tag-white)' },
    { id: '2', value: 'TODO', color: 'var(--linvo-tag-pink)' },
    { id: '3', value: 'WIP', color: 'var(--linvo-tag-blue)' },
  ];

  beforeEach(() => {
    doc = createTestDoc();

    rootId = doc.addBlock('linvo:page', {
      title: new Text('database test'),
    });
    noteBlockId = doc.addBlock('linvo:note', {}, rootId);
