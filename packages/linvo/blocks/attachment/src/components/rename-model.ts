import { ConfirmIcon } from '@linvo/linvo-components/icons';
import { toast } from '@linvo/linvo-components/toast';
import type { AttachmentBlockModel } from '@linvo/linvo-model';
import { CitationProvider } from '@linvo/linvo-shared/services';
...
export const RenameModal = ({
  ...
  return html`
    ...
    <div class="linvo-attachment-rename-overlay-mask" @click="${abort}"></div>
    <div class="linvo-attachment-rename-container">
      <div class="linvo-attachment-rename-input-wrapper">
        <input
          ${ref(inputRef)}
          type="text"
          .value=${fileName}
          ...
          @keydown=${onKeydown}
        />
        <span class="linvo-attachment-rename-extension">${extension}</span>
      </div>
      <editor-icon-button
        class="linvo-confirm-button"
        .iconSize=${'24px'}
        @click=${onConfirm}
      >
        ${ConfirmIcon}
