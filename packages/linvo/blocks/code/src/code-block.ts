...
import type { CodeBlockModel } from '@linvo/linvo-model';
import { focusTextModel, type RichText } from '@linvo/linvo-rich-text';
import {
  BRACKET_PAIRS,
...
import { IS_MAC, IS_MOBILE } from '@linvo/global/env';
...
export class CodeBlockComponent extends CaptionedBlockComponent<CodeBlockModel> {
  ...
  override renderBlock(): TemplateResult<1> {
    ...
    return html`
      <div
        class=${classMap({
          'linvo-code-block-container': true,
      ...
      >
        ...
        <div
          ...
          class="linvo-code-block-preview"
        >
