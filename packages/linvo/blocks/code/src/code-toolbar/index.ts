import { HoverController } from '@linvo/linvo-components/hover';
import type {
  AdvancedMenuItem,
  MenuItemGroup,
...
export const LINVO_CODE_TOOLBAR_WIDGET = 'linvo-code-toolbar-widget';
export class LinvoCodeToolbarWidget extends WidgetComponent<
  CodeBlockModel,
  CodeBlockComponent
> {
  ...
  private readonly _setHoverController = () => {
    ...
    this._hoverController = new HoverController(
      ...
      ({ abortController }) => {
        ...
        return {
          template: html`<linvo-code-toolbar
            .context=${context}
