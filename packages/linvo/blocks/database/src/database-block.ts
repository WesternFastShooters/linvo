...
import { PeekViewProvider } from '@linvo/linvo-components/peek';
...
import { getDropResult } from '@linvo/linvo-widget-drag-handle';
import {
  createRecordDetail,
...
import { Rect } from '@linvo/global/gfx';
import {
  CommentIcon,
  CopyIcon,
  DeleteIcon,
...
export class DatabaseBlockComponent extends CaptionedBlockComponent<DatabaseBlockModel> {
  ...
  private readonly renderTitle = (dataViewLogic: DataViewUILogicBase) => {
    return html` <linvo-database-title
...
declare global {
  interface HTMLElementTagNameMap {
    'linvo-database': DatabaseBlockComponent;
  }
}
