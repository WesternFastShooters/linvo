...
export function effects() {
  customElements.define('linvo-database-title', DatabaseTitle);
  customElements.define('data-view-header-area-icon', IconCell);
  customElements.define('linvo-database-link-cell', LinkCell);
  customElements.define('data-view-header-area-text', HeaderAreaTextCell);
  customElements.define('linvo-database-rich-text-cell', RichTextCell);
  customElements.define('linvo-database-created-time-cell', CreatedTimeCell);
  ...
  customElements.define('linvo-database', DatabaseBlockComponent);

  customElements.define(
    'linvo-dnd-preview-database',
