...
import type { DividerBlockModel } from '@linvo/linvo-model';
import { BLOCK_CHILDREN_CONTAINER_PADDING_LEFT } from '@linvo/linvo-shared/consts';
...
export class DividerBlockComponent extends CaptionedBlockComponent<DividerBlockModel> {
  ...
  override renderBlock() {
    ...
    return html`
      <div class="linvo-divider-block-container">
        <hr />
...
declare global {
  interface HTMLElementTagNameMap {
    'linvo-divider': DividerBlockComponent;
  }
}
