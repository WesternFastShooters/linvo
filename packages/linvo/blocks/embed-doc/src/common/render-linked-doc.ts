import { getNotesFromDoc } from '@linvo/linvo-block-embed';
...
import { EMBED_CARD_HEIGHT } from '@linvo/linvo-shared/consts';
import { matchModels } from '@linvo/linvo-shared/utils';
import { BlockStdScope } from '@linvo/std';
import type { BlockModel, Query } from '@linvo/store';
...
async function renderNoteContent(
  ...
  noteBlocksContainer.classList.add('linvo-embed-doc-content-note-blocks');
