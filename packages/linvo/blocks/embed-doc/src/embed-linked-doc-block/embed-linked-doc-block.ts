...
import { isPeekable, Peekable } from '@linvo/linvo-components/peek';
...
export class EmbedLinkedDocBlockComponent extends EmbedBlockComponent<EmbedLinkedDocModel> {
  ...
  private readonly _renderEmbedView = () => {
    ...
    return this.renderEmbed(
      () => html`
        <div
          class="linvo-embed-linked-doc-block ${cardClassMap}"
          @click=${this._handleClick}
          @dblclick=${this._handleDoubleClick}
        >
          <div class="linvo-embed-linked-doc-content">
            <div class="linvo-embed-linked-doc-content-title">
              <div class="linvo-embed-linked-doc-content-title-icon">
                ${icon}
              </div>

              <div class="linvo-embed-linked-doc-content-title-text">
                ${title}
              </div>
            </div>
            ...
            ${when(
              hasDescriptionAlias,
              () =>
                html`<div class="linvo-embed-linked-doc-content-note alias">
                  ${repeat(
              ...
              () =>
                when(
                  ...
                  () => html`
                    <div class="linvo-embed-linked-doc-content-note default">
                      ${defaultNoteContent}
                    </div>
                  `,
                  () => html`
                    <div
                      class="linvo-embed-linked-doc-content-note render"
                    ></div>
                  `
                )
            )}
            ${isError
              ? html`
                  <div class="linvo-embed-linked-doc-card-content-reload">
                    <div
                      class="linvo-embed-linked-doc-card-content-reload-button"
                ...
                `
              : html`
                  <div class="linvo-embed-linked-doc-content-date">
                    <span>Updated</span>
          ...
          ${showDefaultBanner
            ? html`
                <div class="linvo-embed-linked-doc-banner default">
                  ${defaultBanner}
                </div>
              `
            : nothing}
  ...
  @queryAsync('.linvo-embed-linked-doc-content-note.render')
