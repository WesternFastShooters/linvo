import { toEdgelessEmbedBlock } from '@linvo/linvo-block-embed';
import {
  EdgelessCRUDIdentifier,
  reassociateConnectorsCommand,
} from '@linvo/linvo-block-surface';
import { type AliasInfo } from '@linvo/linvo-model';
import {
  EMBED_CARD_HEIGHT,
  EMBED_CARD_WIDTH,
...
export class EmbedEdgelessSyncedDocBlockComponent extends toEdgelessEmbedBlock(
  ...
  @query('.linvo-embed-synced-doc-edgeless-header-wrapper')
  accessor headerWrapper: HTMLDivElement | null = null;

  @query('linvo-preview-root')
    ...
    return this.renderEmbed(
      () => html`
        <div
          ...
          ?data-scale=${scale}
        >
          <div class="linvo-embed-synced-doc-edgeless-header-wrapper">
            ${header}
          </div>
          ...
          <div class="linvo-embed-synced-doc-editor-overlay"></div>
        </div>
      `
    );
  };
