import { embedNoteContentStyles } from '@linvo/linvo-block-embed';
import {
  EMBED_CARD_HEIGHT,
  EMBED_CARD_WIDTH,
...
export const blockStyles = css`
  ...
  linvo-embed-synced-doc-block[data-page-mode] {
  ...
  .edgeless-block-portal-embed
    > linvo-embed-synced-doc-block[data-nested-editor] {
    position: relative;
    display: block;
    left: 0px;
    top: 0px;
  ...
  .edgeless-block-portal-embed .linvo-embed-synced-doc-container.edgeless {
    display: block;
    padding: 0;
    width: 100%;
    height: calc(${EMBED_CARD_HEIGHT.syncedDoc}px + 36px);
  }
  .edgeless-block-portal-embed .linvo-embed-synced-doc-container.surface {
    border: 1px solid var(--linvo-border-color);
  }

  linvo-embed-synced-doc-block[data-nested-editor],
  linvo-embed-edgeless-synced-doc-block[data-nested-editor] {
    .linvo-embed-synced-doc-container.page {
  ...
  .linvo-embed-synced-doc-container {
    border: 1px solid transparent;
    border-radius: 8px;
    overflow: hidden;
  }
  .linvo-embed-synced-doc-container.comment-highlighted {
    outline: 2px solid ${unsafeCSSVarV2('block/comment/highlightUnderline')};
  }
  .linvo-embed-synced-doc-container.show-hover-border:hover {
  ...
  .linvo-embed-synced-doc-container.edgeless {
    display: block;
    width: 100%;
    height: calc(${EMBED_CARD_HEIGHT.syncedDoc}px + 36px);
  }
  .linvo-embed-synced-doc-header-wrapper {
    position: absolute;
    top: 0;
    left: 0;
    height: 34px;
    width: 100%;
    background-color: var(--linvo-white);
    opacity: 0;
  }
  @media print {
    .linvo-embed-synced-doc-header-wrapper {
  ...
  .linvo-embed-synced-doc-header-wrapper.selected {
    opacity: 1;
    transition: all 0.23s ease;
  }
  .linvo-embed-synced-doc-header {
    display: flex;
    align-items: center;
    width: 100%;
    height: 100%;
  ...
  .linvo-embed-synced-doc-header svg {
    flex-shrink: 0;
  }
  .linvo-embed-synced-doc-icon {
    line-height: 0;
    color: ${unsafeCSSVarV2('icon/primary')};
  }
  .linvo-embed-synced-doc-title {
    font-size: 14px;
    font-weight: 600;
    line-height: 22px;
    margin-left: 8px;
  ...
  .linvo-embed-synced-doc-editor-overlay {
    position: absolute;
    top: 0;
    left: 0;
    width: 100%;
  ...
  .linvo-embed-synced-doc-editor-empty {
    display: flex;
    align-items: center;
    width: 100%;
    height: 100%;
  ...
  .linvo-embed-synced-doc-container.surface
    > .linvo-embed-synced-doc-editor
    > .linvo-embed-synced-doc-editor-empty {
    left: 0;
  ...
  .linvo-embed-synced-doc-editor-empty > span {
  ...
  .linvo-embed-synced-doc-container
    > .linvo-embed-synced-doc-editor.linvo-page-viewport {
    background: transparent;
  }

  .linvo-embed-synced-doc-container > .linvo-embed-synced-doc-editor {
    width: 100%;
    height: 100%;
  }
...
export const cardStyles = css`
  ...
  .linvo-embed-synced-doc-card-content {
  ...
  .linvo-embed-synced-doc-card-content-title {
    display: flex;
    flex-direction: row;
    gap: 8px;
    align-items: center;
  ...
  .linvo-embed-synced-doc-card-content-title-icon {
    display: flex;
    width: 16px;
    height: 16px;
    justify-content: center;
  ...
  .linvo-embed-synced-doc-card-content-title-icon svg {
    width: 16px;
    height: 16px;
    fill: var(--linvo-background-primary-color);
  }

  .linvo-embed-synced-doc-card-content-title-text {
    display: -webkit-box;
    -webkit-line-clamp: 1;
  ...
  .linvo-embed-synced-doc-content-note.render {
    display: none;
    overflow: hidden;
    pointer-events: none;
  }
  ...
  .linvo-embed-synced-doc-content-note.default {
    display: -webkit-box;
    -webkit-line-clamp: 2;
    -webkit-box-orient: vertical;
    white-space: normal;
  ...
  .linvo-embed-synced-doc-card-content-date,
  .linvo-embed-synced-doc-card-content-reload {
    display: flex;
    flex-grow: 1;
  ...
  .linvo-embed-synced-doc-card-content-date > span {
    display: -webkit-box;
    -webkit-line-clamp: 1;
    -webkit-box-orient: vertical;
  ...
  .linvo-embed-synced-doc-card-content-reload-button {
    display: flex;
    flex-direction: row;
    align-items: center;
    gap: 4px;
  ...
  .linvo-embed-synced-doc-card-content-reload-button svg {
    width: 12px;
    height: 12px;
  }
  .linvo-embed-synced-doc-card-content-reload-button > span {
    display: -webkit-box;
    -webkit-line-clamp: 1;
    -webkit-box-orient: vertical;
    word-break: break-all;
  ...
  .linvo-embed-synced-doc-card-banner {
  ...
  .linvo-embed-synced-doc-card-banner.render {
    display: none;
  }
  .linvo-embed-synced-doc-card-banner img,
  .linvo-embed-synced-doc-card-banner object,
  .linvo-embed-synced-doc-card-banner svg {
    width: 204px;
    max-width: 100%;
    height: 102px;
    object-fit: cover;
  ...
  .linvo-embed-synced-doc-card.loading,
  .linvo-embed-synced-doc-card.deleted,
  .linvo-embed-synced-doc-card.error {
    .linvo-embed-linked-doc-content-note.render {
      display: none;
    }
    .linvo-embed-linked-doc-content-note.default {
      display: block;
    }
    .linvo-embed-synced-doc-card-banner.render {
      display: none;
    }
    .linvo-embed-synced-doc-card-banner.default {
      display: block;
    }
    .linvo-embed-synced-doc-card-content-date {
      display: none;
  ...
  .linvo-embed-synced-doc-card:not(.loading).deleted,
  .linvo-embed-synced-doc-card:not(.loading).error {
    background: var(--linvo-background-secondary-color);
  }
  .linvo-embed-synced-doc-card:not(.loading):not(.error):not(
      .surface
    ).deleted {
  ...
  .linvo-embed-synced-doc-card:not(.loading):not(.error):not(.deleted):not(
      .note-empty
    ).cycle {
    .linvo-embed-synced-doc-content-note.render {
      display: block;
  ...
  .linvo-embed-synced-doc-card.surface:not(.cycle) {
    ...
    .linvo-embed-synced-doc-card-content-note {
      margin: 0 auto;
      flex-grow: 0;
    }
  ...
  .linvo-embed-synced-doc-card.surface:not(.loading):not(.error):not(
      .deleted
    ).cycle {
  ...
  .linvo-embed-synced-doc-edgeless-header-wrapper {
    position: relative;
