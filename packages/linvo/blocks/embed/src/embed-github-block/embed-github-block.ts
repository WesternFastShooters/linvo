import { LoadingIcon, OpenIcon } from '@linvo/linvo-components/icons';
import type {
  EmbedGithubModel,
  EmbedGithubStyles,
} from '@linvo/linvo-model';
import { ImageProxyService } from '@linvo/linvo-shared/adapters';
import { ThemeProvider } from '@linvo/linvo-shared/services';
import { BlockSelection, isGfxBlockComponent } from '@linvo/std';
  ...
  override renderBlock() {
    ...
    return this.renderEmbed(
      () => html`
        ...
        >
          <div class="linvo-embed-github-content">
            <div class="linvo-embed-github-content-title">
              <div class="linvo-embed-github-content-title-icons">
                <div class="linvo-embed-github-content-title-site-icon">
                  ${titleIcon}
                </div>
                ...
                ${status && statusText
                  ? html`<div
                      class=${classMap({
                        'linvo-embed-github-content-title-status-icon': true,
                        [githubType]: true,
                        [status]: true,
              ...
              <div class="linvo-embed-github-content-title-text">
                ${titleText}
              </div>
            </div>

            <div class="linvo-embed-github-content-description">
              ${descriptionText}
            </div>

            ${githubType === 'issue' && assignees
              ? html`
                  <div class="linvo-embed-github-content-assignees">
                    <div
                      class="linvo-embed-github-content-assignees-text label"
                    >
                      Assignees
                    </div>

                    <div
                      class="linvo-embed-github-content-assignees-text users"
                    >
                      ${assignees.length === 0
                        ? html`<span
                            class="linvo-embed-github-content-assignees-text-users placeholder"
                            >No one</span
                          >`
                        : repeat(
                            assignees,
                            ...
                            (assignee, index) =>
                              html`<span
                                  class="linvo-embed-github-content-assignees-text-users user"
                                  @click=${() =>
            ...
            <div class="linvo-embed-github-content-url" @click=${this.open}>
              <span class="linvo-embed-github-content-repo"
                >${`${owner}/${repo} |`}</span
              >

              ${createdAt
                ? html`<span class="linvo-embed-github-content-date"
                    >${dateText} |</span
                  >`
                : nothing}
              <span>github.com</span>

              <div class="linvo-embed-github-content-url-icon">
                ${OpenIcon}
              </div>
            </div>
          </div>
          <div class="linvo-embed-github-banner">${bannerImage}</div>
        </div>
      `
    );
  }
