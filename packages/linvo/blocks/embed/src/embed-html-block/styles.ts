...
export const styles = css`
  ...
  .linvo-embed-html img,
  .linvo-embed-html object,
  .linvo-embed-html svg {
    width: 100%;
    height: 100%;
    object-fit: cover;
    border-radius: 4px;
  ...
  .linvo-embed-html-iframe-container {
    position: relative;
    width: 100%;
    height: 100%;
  ...
  .embed-html-block-iframe-wrapper linvo-menu {
    min-width: 296px;
  }

  .embed-html-block-iframe-wrapper linvo-menu .settings-header {
    padding: 7px 12px;
    font-weight: 500;
  ...
  .linvo-embed-html-iframe-overlay {
    position: absolute;
    top: 0;
    left: 0;
    width: 100%;
  ...
  .linvo-embed-html-iframe-overlay.hide {
    display: none;
  }

  .linvo-embed-html-title {
    height: fit-content;
    display: flex;
    align-items: center;
    gap: 8px;
  ...
  .linvo-embed-html-title-icon img,
  .linvo-embed-html-title-icon object,
  .linvo-embed-html-title-icon svg {
    width: 20px;
    height: 20px;
    fill: var(--linvo-background-primary-color);
  }

  .linvo-embed-html-title-text {
    display: -webkit-box;
    -webkit-line-clamp: 1;
