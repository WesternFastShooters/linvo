...
import type { EmbedIframeBlockModel } from '@linvo/linvo-model';
import {
  DocModeProvider,
  TelemetryProvider,
...
export class EmbedIframeErrorCard extends WithDisposable(LitElement) {
  static override styles = css`
    ...
    .linvo-embed-iframe-error-card {
      container: linvo-embed-iframe-error-card / size;
      display: flex;
    ...
    .linvo-embed-iframe-error-card.horizontal {
      flex-direction: row;
      ...
      @container linvo-embed-iframe-error-card (width < 480px) {
        .error-banner {
          display: none;
        }
      }
    ...
    .linvo-embed-iframe-error-card.vertical {
      ...
      @container linvo-embed-iframe-error-card (height < 300px) or (width < 300px) {
        .error-banner {
          display: none;
        }
      }
  ...
  override render() {
    ...
    const cardClasses = classMap({
      'linvo-embed-iframe-error-card': true,
