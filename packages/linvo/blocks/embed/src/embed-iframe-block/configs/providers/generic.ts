import { EmbedIframeConfigExtension } from '@linvo/linvo-shared/services';
...
/**
 * Linvo-managed domains that should be excluded from generic embedding
 * These are based on the current cloud constants and known Linvo domains
 */
const LINVO_DOMAINS = [
  'linvo.pro', // Main Linvo domain
  'app.linvo.pro', // Stable cloud domain
  'insider.linvo.pro', // Beta/internal cloud domain
  'linvo.fail', // Canary cloud domain
  'toeverything.app', // Safety measure for potential future use
  'apple.getlinvoapp.com', // Cloud domain for Apple app
];

/**
 * Validates if a URL is suitable for generic iframe embedding
 * Allows HTTPS URLs but excludes Linvo-managed domains
