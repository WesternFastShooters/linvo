...
export const styles = css`
  ...
  .linvo-embed-loom-video {
    flex-grow: 1;
    width: 100%;
  }

  .linvo-embed-loom-video img,
  .linvo-embed-loom-video object,
  .linvo-embed-loom-video svg {
    width: 100%;
    height: 100%;
    object-fit: cover;
    border-radius: 4px;
  ...
  .linvo-embed-loom-video-iframe-container {
    position: relative;
    height: 100%;
  }

  .linvo-embed-loom-video-iframe-container > iframe {
    width: 100%;
    height: 100%;
    border-radius: 4px;
  }

  .linvo-embed-loom-video-iframe-overlay {
    position: absolute;
    top: 0;
    left: 0;
    width: 100%;
  ...
  .linvo-embed-loom-video-iframe-overlay.hide {
    display: none;
  }

  .linvo-embed-loom-content {
    display: flex;
    flex-direction: column;
    width: 100%;
    height: fit-content;
  ...
  .linvo-embed-loom-content-header {
    display: flex;
    flex-direction: row;
    gap: 8px;
    align-items: center;
  ...
  .linvo-embed-loom-content-title-icon {
    display: flex;
    width: 20px;
    height: 20px;
  ...
  .linvo-embed-loom-content-title-icon img,
  .linvo-embed-loom-content-title-icon object,
  .linvo-embed-loom-content-title-icon svg {
    width: 20px;
    height: 20px;
    fill: var(--linvo-background-primary-color);
  }

  .linvo-embed-loom-content-title-text {
    flex: 1 0 0;
  ...
  .linvo-embed-loom-content-description {
    display: -webkit-box;
    -webkit-line-clamp: 2;
    -webkit-box-orient: vertical;
  ...
  .linvo-embed-loom-content-url > span {
    display: -webkit-box;
    -webkit-line-clamp: 1;
    -webkit-box-orient: vertical;
  ...
  .linvo-embed-loom-content-url:hover > span {
    color: var(--linvo-link-color);
  }
  .linvo-embed-loom-content-url:hover .open-icon {
    fill: var(--linvo-link-color);
  }

  .linvo-embed-loom-content-url-icon {
    display: flex;
    align-items: center;
    justify-content: center;
    width: 12px;
  ...
  .linvo-embed-loom-content-url-icon .open-icon {
    height: 12px;
    width: 12px;
    fill: var(--linvo-text-secondary-color);
  }

  .linvo-embed-loom-block.loading {
    .linvo-embed-loom-content-title-text {
      color: var(--linvo-placeholder-color);
    }
  }

  .linvo-embed-loom-block.selected {
    .linvo-embed-loom-content-url > span {
      color: var(--linvo-link-color);
    }
    .linvo-embed-loom-content-url .open-icon {
      fill: var(--linvo-link-color);
    }
  }
`;
