import { autoResizeElementsCommand } from '@linvo/linvo-block-surface';
...
import { Bound, type IVec, Vec } from '@linvo/global/gfx';
import { BlockSelection, type BlockStdScope } from '@linvo/std';
