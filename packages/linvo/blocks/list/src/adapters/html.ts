import { ListBlockSchema } from '@linvo/linvo-model';
import {
  AdapterTextUtils,
...
export const listBlockHtmlAdapterMatcher: BlockHtmlAdapterMatcher = {
  ...
  fromBlockSnapshot: {
    enter: (o, context) => {
      ...
      if (
        walkerContext.getNodeContext('linvo:list:parent') === o.parent &&
        ...
        walkerContext.setNodeContext('linvo:list:parent', o.parent);
      }
      ...
      walkerContext.openNode(
        {
          ...
          tagName: 'li',
          properties: {
            className: ['linvo-list-block-container'],
          },
          children: liChildren,
        },
        'children'
    ...
    leave: (o, context) => {
      ...
      if (
        walkerContext.getPreviousNodeContext('linvo:list:parent') ===
          o.parent &&
