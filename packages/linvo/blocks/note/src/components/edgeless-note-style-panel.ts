...
import {
  ...
  type PickColorEvent,
  preprocessColor,
} from '@linvo/linvo-components/color-picker';
import type { LineDetailType } from '@linvo/linvo-components/edgeless-line-styles-panel';
import type { SliderSelectEvent } from '@linvo/linvo-components/slider';
import {
  DefaultTheme,
  NoteBlockModel,
  type NoteProps,
  ...
  private _renderStylePanel() {
    return html`<div class="edgeless-note-style-panel">
      ...
      <div
        ...
        data-testid="linvo-note-border-style-panel"
      >
      ...
      <div
        class="edgeless-note-style-section"
        data-testid="linvo-note-corner-radius-panel"
      >
