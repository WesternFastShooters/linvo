...
import type { DocTitle } from '@linvo/linvo-fragment-doc-title';
import { NoteBlockSchema, NoteDisplayMode } from '@linvo/linvo-model';
...
export const LINVO_EDGELESS_NOTE = 'linvo-edgeless-note';
...
declare global {
  interface HTMLElementTagNameMap {
    [LINVO_EDGELESS_NOTE]: EdgelessNoteBlockComponent;
  }
}
