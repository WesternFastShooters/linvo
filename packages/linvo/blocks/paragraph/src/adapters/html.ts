import { ParagraphBlockSchema } from '@linvo/linvo-model';
import {
...
import type { DeltaInsert, NodeProps } from '@linvo/store';
            ...
            .openNode(
              {
                ...
                tagName: 'div',
                properties: {
                  className: ['linvo-paragraph-block-container'],
                },
                children: [],
              },
              'children'
            ...
            .openNode(
              {
                ...
                tagName: 'div',
                properties: {
                  className: ['linvo-block-children-container'],
