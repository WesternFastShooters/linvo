import { ListBlockModel, ParagraphBlockModel } from '@linvo/linvo-model';
import type { IndentContext } from '@linvo/linvo-shared/types';
import {
...
export const indentParagraphCommand: Command<{
  ...
  if (
    ...
    indentContext.flavour !== 'linvo:paragraph'
  ) {
    console.warn(
  ...
  // update collapsed state of linvo list
  if (
