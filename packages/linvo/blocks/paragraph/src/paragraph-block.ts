...
export class ParagraphBlockComponent extends CaptionedBlockComponent<ParagraphBlockModel> {
  ...
  private readonly _isInDatabase = () => {
    ...
    while (parent && parent !== document.body) {
      if (parent.tagName.toLowerCase() === 'linvo-database') {
        return true;
      }
  ...
  override renderBlock(): TemplateResult<1> {
    ...
    return html`
      ${style}
      <style>
        .linvo-paragraph-block-container[data-has-collapsed-siblings='false']
          linvo-paragraph-heading-icon
          .heading-icon {
      ...
      <div
        class=${classMap({
          'linvo-paragraph-block-container': true,
      ...
      >
        <div
          class=${classMap({
            'linvo-paragraph-rich-text-wrapper': true,
            [type$.value]: true,
          ...
          ${this.inEdgelessText
            ...
            : html`
                <div
                  ...
                  class=${classMap({
                    'linvo-paragraph-placeholder': true,
  ...
  override accessor blockContainerStyles = {
    margin: 'var(--linvo-paragraph-margin, 10px 0)',
  };
}
