...
} from '@linvo/linvo-block-database';
import {
...
import type { HighlightType } from '@linvo/linvo-components/highlight-dropdown-menu';
...
import { textConversionConfigs } from '@linvo/linvo-rich-text';
import {
...
import { tableViewMeta } from '@linvo/data-view/view-presets';
import {
  CopyIcon,
...
import { toDraftModel } from '@linvo/store';
      ...
      content: html`
        ...
        >
          <div data-size="large" data-orientation="vertical">
            ${repeat(
              textConversionConfigs.filter(c => c.flavour !== 'linvo:divider'),
              item => item.name,
