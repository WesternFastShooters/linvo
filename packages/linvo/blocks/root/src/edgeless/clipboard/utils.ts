...
import type { FrameBlockProps } from '@linvo/linvo-model';
import { encodeClipboardBlobs } from '@linvo/linvo-shared/adapters';
import { Bound, getBoundWithRotation } from '@linvo/global/gfx';
...
import { type BlockSnapshot, BlockSnapshotSchema } from '@linvo/store';
