import { insertLinkByQuickSearchCommand } from '@linvo/linvo-block-bookmark';
import { EdgelessTextBlockComponent } from '@linvo/linvo-block-edgeless-text';
import {
  FrameTool,
  type PresentToolOption,
} from '@linvo/linvo-block-frame';
import {
  DefaultTool,
...
import {
  ...
  HighlighterTool,
  MagicBrushTool,
} from '@linvo/linvo-gfx-brush';
import {
  ConnectorPathGenerator,
  ConnectorTool,
  mountConnectorLabelEditor,
} from '@linvo/linvo-gfx-connector';
import {
  createGroupFromSelectedCommand,
  ungroupCommand,
} from '@linvo/linvo-gfx-group';
import {
  getNearestTranslation,
  isElementOutsideViewport,
  isSingleMindMapNode,
} from '@linvo/linvo-gfx-mindmap';
import { NoteTool } from '@linvo/linvo-gfx-note';
import { PanTool } from '@linvo/linvo-gfx-pointer';
import { mountShapeTextEditor, ShapeTool } from '@linvo/linvo-gfx-shape';
import { TextTool } from '@linvo/linvo-gfx-text';
import {
...
} from '@linvo/linvo-widget-edgeless-selected-rect';
import { IS_MAC } from '@linvo/global/env';
import { Bound, getCommonBound } from '@linvo/global/gfx';
import { SurfaceSelection, TextSelection } from '@linvo/std';
import {
  type BaseTool,
