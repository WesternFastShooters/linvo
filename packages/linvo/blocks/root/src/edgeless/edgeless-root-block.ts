import { NoteConfigExtension } from '@linvo/linvo-block-note';
import {
  DefaultTool,
  getBgGridGap,
...
import { isSingleMindMapNode } from '@linvo/linvo-gfx-mindmap';
import { PanTool } from '@linvo/linvo-gfx-pointer';
import { mountShapeTextEditor } from '@linvo/linvo-gfx-shape';
import {
  NoteBlockModel,
  type RootBlockModel,
...
import { IS_WINDOWS } from '@linvo/global/env';
import { Bound, Point, Vec } from '@linvo/global/gfx';
import {
  BlockComponent,
