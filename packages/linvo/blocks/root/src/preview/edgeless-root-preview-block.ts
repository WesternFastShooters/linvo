...
import { requestThrottledConnectedFrame } from '@linvo/linvo-shared/utils';
import {
  BlockComponent,
...
export class EdgelessRootPreviewBlockComponent extends BlockComponent<RootBlockModel> {
  static override styles = css`
    ...
    linvo-edgeless-root-preview .widgets-container {
      position: absolute;
      left: 0;
      top: 0;
      contain: size layout;
    ...
    linvo-edgeless-root-preview .edgeless-background {
      height: 100%;
