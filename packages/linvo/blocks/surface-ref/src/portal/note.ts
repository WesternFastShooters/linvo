import type { CanvasRenderer } from '@linvo/linvo-block-surface';
...
import { RANGE_QUERY_EXCLUDE_ATTR } from '@linvo/std/inline';
import { type BlockModel, type Query } from '@linvo/store';
...
export class SurfaceRefNotePortal extends WithDisposable(ShadowlessElement) {
  ...
  override render() {
    ...
    const style = {
      ...
      border: `${EDGELESS_BLOCK_CHILD_BORDER_WIDTH}px none var(--linvo-black-10)`,
      backgroundColor,
