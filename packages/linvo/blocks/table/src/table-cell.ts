...
import { TextBackgroundDuotoneIcon } from '@linvo/linvo-components/icons';
import { DefaultInlineManagerExtension } from '@linvo/linvo-inline-preset';
import type { TableColumn, TableRow } from '@linvo/linvo-model';
import { RichText } from '@linvo/linvo-rich-text';
...
export const TableCellComponentName = 'linvo-table-cell';
export class TableCell extends SignalWatcher(
  ...
  get inlineManager() {
    return this.closest<TableBlockComponent>('linvo-table')?.std.get(
      DefaultInlineManagerExtension.identifier
    );
  }

  get topContenteditableElement() {
    return this.closest<TableBlockComponent>('linvo-table')
        ...
        <rich-text
          ...
          .verticalScrollContainerGetter="${() =>
            this.topContenteditableElement?.host
              ...
              : null}"
          data-parent-flavour="linvo:table"
        ></rich-text>
