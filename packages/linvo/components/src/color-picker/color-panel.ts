import type { Color, ColorScheme, Palette } from '@linvo/linvo-model';
import { DefaultTheme, resolveColor } from '@linvo/linvo-model';
import { unsafeCSSVarV2 } from '@linvo/linvo-shared/theme';
import { ColorEvent } from '@linvo/linvo-shared/utils';
