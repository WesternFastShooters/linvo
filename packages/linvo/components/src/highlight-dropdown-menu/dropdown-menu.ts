...
export class HighlightDropdownMenu extends LitElement {
  ...
  override render() {
    const prefix = '--linvo-text-highlight';
      ...
      <editor-menu-button
        ...
        .button=${html`
          <editor-icon-button aria-label="highlight" .tooltip="${'Highlight'}">
            <linvo-highlight-duotone-icon
              style=${styleMap({
                '--color':
                  // latestHighlightColor ?? 'var(--linvo-text-primary-color)',
                  'var(--linvo-text-primary-color)',
              })}
            ></linvo-highlight-duotone-icon>
            ${EditorChevronDown}
          </editor-icon-button>
        ...
        <div data-size="large" data-orientation="vertical">
          ...
          ${repeat(colors, color => {
            ...
            return html`
              ...
              >
                <linvo-text-duotone-icon
                  style=${styleMap({
                    '--color': value ?? 'var(--linvo-text-primary-color)',
                  })}
                ></linvo-text-duotone-icon>
