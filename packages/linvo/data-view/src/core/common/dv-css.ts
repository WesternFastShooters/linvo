...
export const dataViewVars = {
  cellTextSize: '--linvo-data-view-cell-text-size',
  cellTextLineHeight: '--linvo-data-view-cell-text-line-height',
};
...
export const hover = css({
  '&:hover, &.active': {
    backgroundColor: 'var(--linvo-hover-color)',
    cursor: 'pointer',
  },
});
...
export const shadow2 = css({
  boxShadow: 'var(--linvo-shadow-2)',
});

export const dividerH = css({
  height: '1px',
  backgroundColor: 'var(--linvo-divider-color)',
  margin: '8px 0',
});
