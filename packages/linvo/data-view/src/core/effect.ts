...
export function coreEffects() {
  ...
  customElements.define('linvo-lit-icon', LinvoLitIcon);
  customElements.define('data-view-group-setting', GroupSetting);
  customElements.define('linvo-multi-tag-select', MultiTagSelect);
  customElements.define('data-view-group-title-boolean-view', BooleanGroupView);
  customElements.define('linvo-multi-tag-view', MultiTagView);
  ...
  customElements.define('linvo-data-view-record-detail', RecordDetail);
}
