...
const styles = css`
  linvo-data-view-kanban-card {
    ...
    background-color: var(--linvo-background-kanban-card-color);
  }

  linvo-data-view-kanban-card:hover {
    background-color: var(--linvo-hover-color);
  }

  linvo-data-view-kanban-card .card-header {
    padding: 8px;
    display: flex;
    flex-direction: column;
    gap: 8px;
  ...
  linvo-data-view-kanban-card .card-header-title uni-lit {
    width: 100%;
  }
  ...
  linvo-data-view-kanban-card .card-header-title {
    font-size: var(--data-view-cell-text-size);
    line-height: var(--data-view-cell-text-line-height);
  }

  linvo-data-view-kanban-card .card-header-icon {
    padding: 4px;
  ...
  linvo-data-view-kanban-card .card-header-icon svg {
    width: 16px;
    height: 16px;
  ...
  linvo-data-view-kanban-card .card-body {
    display: flex;
    flex-direction: column;
    padding: 8px;
    gap: 4px;
  ...
  linvo-data-view-kanban-card:hover .card-ops {
    visibility: visible;
  }
  linvo-data-view-kanban-card:has(.active) .card-ops {
    visibility: visible;
  }

  linvo-data-view-kanban-card:has([data-editing='true']) .card-ops {
    visibility: hidden;
  }
...
export class KanbanCard extends SignalWatcher(
  ...
  private readonly contextMenu = (e: MouseEvent) => {
    ...
    if (selection) {
      ...
      const ref = target.closest('linvo-data-view-kanban-cell') ?? this;
      popCardMenu(
        this.kanbanViewLogic,
    ...
    return html` <div class="card-body">
      ${repeat(
        ...
        column => {
          ...
          return html` <linvo-data-view-kanban-cell
            .contentOnly="${false}"
  ...
  override render() {
    ...
    this.style.border = this.isFocus$.value
      ? '1px solid var(--linvo-primary-color)'
      : '';
    return html`
...
declare global {
  interface HTMLElementTagNameMap {
    'linvo-data-view-kanban-card': KanbanCard;
  }
}
