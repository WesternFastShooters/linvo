...
const styles = css`
  ...
  linvo-data-view-kanban-group:hover .group-header-op {
    visibility: visible;
    opacity: 1;
  }
  ...
  linvo-data-view-kanban-group:hover .add-card {
    visibility: visible;
    opacity: 1;
  }

  linvo-data-view-kanban-group .add-card:hover {
...
declare global {
  interface HTMLElementTagNameMap {
    'linvo-data-view-kanban-group': KanbanGroup;
  }
}
