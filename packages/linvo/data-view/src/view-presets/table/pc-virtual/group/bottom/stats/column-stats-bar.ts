...
const styles = css`
  linvo-database-virtual-column-stats {
  ...
  protected override render() {
    ...
    return html`
      ${repeat(
        ...
        col => col.id,
        col => {
          return html`<linvo-database-virtual-column-stats-cell
            .column=${col}
            .group=${this.group}
          ></linvo-database-virtual-column-stats-cell>`;
        }
      )}
    `;
  }
...
declare global {
  interface HTMLElementTagNameMap {
    'linvo-database-virtual-column-stats': VirtualDataBaseColumnStats;
  }
}
