...
const styles = css`
  ...
  linvo-database-virtual-column-stats:hover .stats-cell {
    opacity: 1;
  }

  .stats-cell:hover,
  linvo-database-virtual-column-stats-cell.active .stats-cell {
    opacity: 1;
...
declare global {
  interface HTMLElementTagNameMap {
    'linvo-database-virtual-column-stats-cell': VirtualDatabaseColumnStatsCell;
  }
}
