...
export function pcEffects() {
  ...
  customElements.define('linvo-data-view-table-group', TableGroup);
  customElements.define('dv-table-view-cell-container', TableViewCellContainer);
  customElements.define('linvo-database-column-header', DatabaseColumnHeader);
  customElements.define(
    'linvo-data-view-column-preview',
    DataViewColumnPreview
  );
  customElements.define('linvo-database-header-column', DatabaseHeaderColumn);
  customElements.define(
