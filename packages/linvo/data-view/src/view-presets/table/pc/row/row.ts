...
export class TableRowView extends SignalWatcher(
  ...
  static override styles = css`
    .linvo-database-block-row:has(.row-select-checkbox.selected) {
      background: var(--linvo-primary-color-04);
    }
    .linvo-database-block-row:has(.row-select-checkbox.selected)
      .row-selected-bg {
      position: relative;
    ...
    .linvo-database-block-row.selected > .database-cell {
    ...
    .linvo-database-block-row .show-on-hover-row {
      visibility: hidden;
      opacity: 0;
    }
    .linvo-database-block-row:hover .show-on-hover-row {
      visibility: visible;
      opacity: 1;
    }
    .linvo-database-block-row:has(.active) .show-on-hover-row {
      visibility: visible;
      opacity: 1;
    }
    .linvo-database-block-row:has([data-editing='true']) .show-on-hover-row {
      visibility: hidden;
      opacity: 0;
    }
    ...
    .row-op {
      ...
      padding: 4px;
      border-radius: 4px;
      box-shadow: var(--linvo-button-shadow);
  ...
  get groupKey() {
    return this.closest<TableGroup>('linvo-data-view-table-group')?.group?.key;
  }
  ...
  override connectedCallback() {
    ...
    this.classList.add('linvo-database-block-row', 'database-row');
  }
            ...
            <div style="display: flex;">
              ...
              >
                <div
                  ...
                  border-radius: 2px;
                  height: 12px;
                  background-color: var(--linvo-placeholder-color);"
                ></div>
              </div>
              <row-select-checkbox
