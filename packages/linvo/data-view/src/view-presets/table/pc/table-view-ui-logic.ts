...
export class TableViewUI extends DataViewUIBase<TableViewUILogic> {
  override connectedCallback(): void {
    ...
    this.classList.add('linvo-database-table', tableViewStyle);
      ...
      return html`
        <div class="${tableGroupsContainerStyle}">
          ${repeat(
            ...
            v => v.key,
            group => {
              return html` <linvo-data-view-table-group
                data-group-key="${group.key}"
                .tableViewLogic="${this.logic}"
                .group="${group}"
              ></linvo-data-view-table-group>`;
            }
          )}
      ...
      <div class="${tableWrapperStyle}" style="${wrapperStyle}">
        ...
        >
          <div
            ...
            class="linvo-database-table-container"
