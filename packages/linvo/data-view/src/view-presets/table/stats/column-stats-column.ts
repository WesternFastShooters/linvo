...
const styles = css`
  ...
  linvo-database-column-stats:hover .stats-cell {
    opacity: 1;
  }

  .stats-cell:hover,
  linvo-database-column-stats-cell.active .stats-cell {
    opacity: 1;
...
declare global {
  interface HTMLElementTagNameMap {
    'linvo-database-column-stats-cell': DatabaseColumnStatsCell;
  }
}
