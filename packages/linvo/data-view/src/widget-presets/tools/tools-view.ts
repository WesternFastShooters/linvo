...
const styles = css`
  ...
  .toolbar-hover-container:hover .linvo-database-toolbar {
    visibility: visible;
    opacity: 1;
  }
  .toolbar-hover-container:has(.active) .linvo-database-toolbar {
    visibility: visible;
    opacity: 1;
  }
