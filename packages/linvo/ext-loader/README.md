# @linvo/linvo-ext-loader

Blocksuite extension loader system for Linvo, providing a structured way to manage and load extensions in different contexts.
...
```typescript
import { BaseExtensionProvider } from '@linvo/linvo-ext-loader';
import { z } from 'zod';
...
```typescript
import { StoreExtensionProvider, StoreExtensionManager } from '@linvo/linvo-ext-loader';
import { z } from 'zod';
...
```typescript
import { ViewExtensionProvider, ViewExtensionManager } from '@linvo/linvo-ext-loader';
import { z } from 'zod';
