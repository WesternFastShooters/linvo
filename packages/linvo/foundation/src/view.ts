import { FileDropExtension } from '@linvo/linvo-components/drop-indicator';
import {
  PeekViewExtension,
  type PeekViewService,
} from '@linvo/linvo-components/peek';
import {
...
import { InteractivityManager, ToolController } from '@linvo/std/gfx';
import { z } from 'zod';
