import type { Store, TransformerMiddleware } from '@linvo/linvo/store';
import {
  type HtmlAdapter,
...
export const LINVO_ADAPTER_PANEL = 'linvo-adapter-panel';
  ...
  override render() {
    return html`
      <div class="adapters-container">
        <linvo-adapter-panel-header
          .updateActiveContent=${this._updateActiveContent}
        ></linvo-adapter-panel-header>
        <linvo-adapter-panel-body></linvo-adapter-panel-body>
      </div>
    `;
  }
...
declare global {
  interface HTMLElementTagNameMap {
    [LINVO_ADAPTER_PANEL]: AdapterPanel;
  }
}
