...
export class DocTitle extends WithDisposable(ShadowlessElement) {
  ...
  private _getOrCreateFirstPageVisibleNote() {
    ...
    const noteId = this.doc.addBlock('linvo:note', {}, this._rootModel, 0);
  ...
  private get _viewport() {
    return (
      this.closest<HTMLElement>('.linvo-page-viewport') ??
      this.closest<HTMLElement>('.linvo-edgeless-viewport')
    );
  }
