...
import { type ExtensionType, type Query, type Store } from '@linvo/store';
...
export const LINVO_FRAME_PREVIEW = 'frame-preview';
...
export class FramePreview extends WithDisposable(ShadowlessElement) {
  ...
  private _initPreviewDoc() {
    const doc = this._originalDoc.workspace.doc;
    this._previewDoc =
