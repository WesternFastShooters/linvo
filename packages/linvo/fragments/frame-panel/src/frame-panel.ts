...
const styles = css`
  ...
  .frame-panel-body:hover::-webkit-scrollbar-thumb {
    background-color: var(--linvo-black-30);
  }
...
export const LINVO_FRAME_PANEL = 'linvo-frame-panel';
...
export class FramePanel extends WithDisposable(ShadowlessElement) {
  ...
  override render() {
    return html`<div class="frame-panel-container">
      <linvo-frame-panel-header
        .editorHost=${this.host}
      ></linvo-frame-panel-header>
      <linvo-frame-panel-body
