...
export const LINVO_OUTLINE_NOTICE = 'linvo-outline-notice';
...
export class OutlineNotice extends SignalWatcher(
  ...
  override render() {
    ...
    return html`
      <div data-testid=${LINVO_OUTLINE_NOTICE} class=${styles.outlineNotice}>
...
declare global {
  interface HTMLElementTagNameMap {
    [LINVO_OUTLINE_NOTICE]: OutlineNotice;
  }
}
