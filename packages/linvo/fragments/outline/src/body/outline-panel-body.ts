import { changeNoteDisplayMode } from '@linvo/linvo-block-note';
import { NoteBlockModel, NoteDisplayMode } from '@linvo/linvo-model';
import { DocModeProvider } from '@linvo/linvo-shared/services';
import { focusTitle, matchModels } from '@linvo/linvo-shared/utils';
...
export const LINVO_OUTLINE_PANEL_BODY = 'linvo-outline-panel-body';
...
declare global {
  interface HTMLElementTagNameMap {
    [LINVO_OUTLINE_PANEL_BODY]: OutlinePanelBody;
  }
}
