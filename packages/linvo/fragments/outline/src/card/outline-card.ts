...
export const LINVO_OUTLINE_NOTE_CARD = 'linvo-outline-note-card';
    ...
    this.disposables.add(
      std.dnd.draggable<NoteCardEntity>({
        ...
        setDragPreview: ({ container, setOffset, location }) => {
          const preview = document.createElement(LINVO_OUTLINE_NOTE_CARD);
...
declare global {
  interface HTMLElementTagNameMap {
    [LINVO_OUTLINE_NOTE_CARD]: OutlineNoteCard;
  }
}
