...
import { DocDisplayMetaProvider } from '@linvo/linvo-shared/services';
...
export const LINVO_OUTLINE_BLOCK_PREVIEW = 'linvo-outline-block-preview';
...
export class OutlineBlockPreview extends SignalWatcher(
  ...
  private _TextBlockPreview(block: ParagraphBlockModel | ListBlockModel) {
    const deltas: DeltaInsert<LinvoTextAttributes>[] =
...
declare global {
  interface HTMLElementTagNameMap {
    [LINVO_OUTLINE_BLOCK_PREVIEW]: OutlineBlockPreview;
  }
}
