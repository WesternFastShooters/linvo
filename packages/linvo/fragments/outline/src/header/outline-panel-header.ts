...
export const LINVO_OUTLINE_PANEL_HEADER = 'linvo-outline-panel-header';
  ...
  override render() {
    ...
    return html`<div class=${styles.container}>
      ...
      <div class=${styles.notePreviewSettingContainer}>
        <linvo-outline-note-preview-setting-menu></linvo-outline-note-preview-setting-menu>
      </div>`;
  }
...
declare global {
  interface HTMLElementTagNameMap {
    [LINVO_OUTLINE_PANEL_HEADER]: OutlinePanelHeader;
  }
}
