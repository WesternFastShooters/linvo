...
export const LINVO_OUTLINE_NOTE_PREVIEW_SETTING_MENU =
  'linvo-outline-note-preview-setting-menu';
...
declare global {
  interface HTMLElementTagNameMap {
    [LINVO_OUTLINE_NOTE_PREVIEW_SETTING_MENU]: OutlineNotePreviewSettingMenu;
  }
}
