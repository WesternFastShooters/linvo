...
export const LINVO_OUTLINE_PANEL = 'linvo-outline-panel';
...
export class OutlinePanel extends SignalWatcher(
  ...
  override render() {
    ...
    return html`
      <linvo-outline-panel-header></linvo-outline-panel-header>
      <linvo-outline-panel-body> </linvo-outline-panel-body>
      <linvo-outline-notice></linvo-outline-notice>
    `;
  }
...
declare global {
  interface HTMLElementTagNameMap {
    [LINVO_OUTLINE_PANEL]: OutlinePanel;
  }
}
