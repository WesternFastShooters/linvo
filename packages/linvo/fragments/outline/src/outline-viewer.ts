...
export const LINVO_OUTLINE_VIEWER = 'linvo-outline-viewer';
...
export class OutlineViewer extends SignalWatcher(
  ...
  static override styles = css`
    ...
    .outline-viewer-indicator {
      ...
      border-radius: 1px;
      overflow: hidden;
      background: var(--linvo-black-10, rgba(0, 0, 0, 0.1));
    }

    .outline-viewer-indicator.active {
      width: 24px;
      background: var(--linvo-text-primary-color);
    }
...
declare global {
  interface HTMLElementTagNameMap {
    [LINVO_OUTLINE_VIEWER]: OutlineViewer;
  }
}
