...
export class EdgelessNoteSeniorButton extends EdgelessToolbarToolMixin(
  ...
  static override styles = css`
    ...
    .note-root[data-app-theme='light'] {
      --paper-border-color: var(--linvo-pure-white);
    ...
    .note-root[data-app-theme='dark'] {
      --paper-border-color: var(--linvo-divider-color);
    ...
    .edgeless-toolbar-note-icon {
      ...
      align-items: center;
      justify-content: center;
      color: var(--linvo-icon-secondary);
  ...
  @state()
  accessor childFlavour: NoteToolOption['childFlavour'] = 'linvo:paragraph';
