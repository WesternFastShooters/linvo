import type { DomRenderer } from '@linvo/linvo-block-surface';
import type { ShapeElementModel } from '@linvo/linvo-model';
import { DefaultTheme, ShapeType } from '@linvo/linvo-model';
import { SVGShapeBuilder } from '@linvo/global/gfx';
