import type { Options, RoughCanvas } from '@linvo/linvo-block-surface';
import { shapeMethods, ShapeType } from '@linvo/linvo-model';
import { Bound, type IVec, type XYWH } from '@linvo/global/gfx';
