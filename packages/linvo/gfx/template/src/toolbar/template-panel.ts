...
import {
  darkToolbarStyles,
  lightToolbarStyles,
} from '@linvo/linvo-components/toolbar';
import {
  EditPropsStore,
  ThemeProvider,
...
import { EdgelessDraggableElementController } from '@linvo/linvo-widget-edgeless-toolbar';
...
export class EdgelessTemplatePanel extends WithDisposable(LitElement) {
  static override styles = css`
    ...
    .edgeless-templates-panel {
      ...
      height: 568px;
      border-radius: 12px;
      background-color: var(--linvo-background-overlay-panel-color);
    ...
    .search-bar {
      padding: 21px 24px;
      font-size: 18px;
      color: var(--linvo-secondary);
      border-bottom: 1px solid var(--linvo-divider-color);
    ...
    .category-entry:hover {
      color: var(--linvo-text-primary-color);
      background-color: var(--linvo-background-tertiary-color);
    }
    ...
    .template-item > svg {
      ...
      width: 135px;
      height: 80px;
      color: var(--linvo-background-primary-color);
    }
    ...
    /* .template-item:hover::before {
      ...
      background-color: var(--linvo-primary-color);
      color: var(--linvo-white);
    } */
    ...
    .template-item:hover::after {
      ...
      height: 100%;
      box-sizing: border-box;
      border: 1px solid var(--linvo-black-10);
      border-radius: 4px;
    ...
    .template-item.loading > linvo-template-loading {
      position: absolute;
      left: 50%;
      top: 50%;
      transform: translate(-50%, -50%);
    ...
    .arrow {
      ...
      color: var(--linvo-background-overlay-panel-color);
    }
  `;
        ...
        <div class="template-viewport">
          <div class="template-scrollcontent" data-scrollable>
            <div class="template-list">
              ${this._loading
                ? html`<linvo-template-loading
                    style=${styleMap({
                      position: 'absolute',
                      left: '50%',
                      top: '50%',
                    })}
                  ></linvo-template-loading>`
                : repeat(
                    _templates,
                      ...
                      return html`
                        ...
                        >
                          ...
                          ${template === this._loadingTemplate
                            ? html`<linvo-template-loading></linvo-template-loading>`
                            : nothing}
                          ${template.name
                            ? html`<linvo-tooltip
                                .offset=${12}
