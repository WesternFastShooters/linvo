import type { EditorIconButton } from '@linvo/linvo-components/toolbar';
...
export class LinkPopup extends WithDisposable(ShadowlessElement) {
  ...
  private readonly _createTemplate = () => {
    ...
    return html`
      <div class="linvo-link-popover create">
        <input
          id="link-input"
          class="linvo-link-popover-input"
          type="text"
          spellcheck="false"
  ...
  private readonly _editTemplate = () => {
    ...
    return html`
      <div class="linvo-link-edit-popover">
        <div class="linvo-edit-area text">
          <input
            class="linvo-edit-input"
            id="text-input"
            type="text"
            placeholder="Enter text"
            @input=${this._updateConfirmBtn}
          />
          <label class="linvo-edit-label" for="text-input">Text</label>
        </div>
        <div class="linvo-edit-area link">
          <input
            id="link-input"
            class="linvo-edit-input"
            type="text"
            ...
            @input=${this._updateConfirmBtn}
          />
          <label class="linvo-edit-label" for="link-input">Link</label>
        </div>
        ${this._confirmBtnTemplate()}
      </div>
    `;
  ...
  @query('.linvo-confirm-button')
  accessor confirmButton: EditorIconButton | null = null;

  @property({ attribute: false })
  accessor inlineEditor!: LinvoInlineEditor;
