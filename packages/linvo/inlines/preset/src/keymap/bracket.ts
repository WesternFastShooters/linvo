import { insertLinkedNode } from '@linvo/linvo-inline-reference';
import { CodeBlockModel } from '@linvo/linvo-model';
import { getInlineEditorByModel } from '@linvo/linvo-rich-text';
import { BRACKET_PAIRS } from '@linvo/linvo-shared/consts';
      ...
      return {
        ...
        [pair.left]: ctx => {
          ...
          if (!isCodeBlock && pair.name === 'square bracket') {
            ...
            // See https://github.com/toeverything/linvo/issues/2730
