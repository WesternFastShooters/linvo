...
import type { DeltaInsert, ExtensionType } from '@linvo/store';

import type { LinvoTextAttributes } from '../../types/index.js';
...
> {
  ...
  deltaToAST(deltas: DeltaInsert<LinvoTextAttributes>[]): string[] {
