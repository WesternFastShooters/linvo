...
import { Extension, type ExtensionType } from '@linvo/store';
...
export const ToolbarModuleIdentifier = createIdentifier<ToolbarModule>(
  'LinvoToolbarModuleIdentifier'
);

export const ToolbarRegistryIdentifier =
  createIdentifier<ToolbarRegistryExtension>('LinvoToolbarRegistryIdentifier');
...
export class ToolbarRegistryExtension extends Extension {
  flavour$ = signal<string>('linvo:note');
