...
export function createLinvoTemplate(
  extensions: ExtensionType[] = DEFAULT_EXTENSIONS
) {
  /**
   * Parse template strings and build editor document structure,
   ...
   *   <linvo-page id="page">
   *     <linvo-note id="note">
   *       <linvo-paragraph id="paragraph-1">Hello, world<anchor /></linvo-paragraph>
   *       <linvo-paragraph id="paragraph-2">Hello, world<focus /></linvo-paragraph>
   *     </linvo-note>
   *   </linvo-page>
   * `;
   * ```
   */
  function linvo(strings: TemplateStringsArray, ...values: any[]) {
...
export const { linvo, block } = createLinvoTemplate();
