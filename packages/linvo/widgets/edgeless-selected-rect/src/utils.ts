...
import { type Shape, ShapeFactory } from '@linvo/linvo-gfx-shape';
import {
  type Connection,
  getShapeRadius,
  getShapeType,
...
import { Bound, normalizeDegAngle, type XYWH } from '@linvo/global/gfx';
...
export function createEdgelessElement(
  ...
  if (isShape(current)) {
    ...
    store.addBlock('linvo:paragraph', {}, note.id);
