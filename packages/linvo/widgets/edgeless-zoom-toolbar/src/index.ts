...
export const LINVO_EDGELESS_ZOOM_TOOLBAR_WIDGET =
  'linvo-edgeless-zoom-toolbar-widget';

export class LinvoEdgelessZoomToolbarWidget extends WidgetComponent<RootBlockModel> {
