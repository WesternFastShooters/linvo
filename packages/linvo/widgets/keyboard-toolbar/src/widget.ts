import { getDocTitleByEditorHost } from '@linvo/linvo-fragment-doc-title';
...
export const LINVO_KEYBOARD_TOOLBAR_WIDGET = 'linvo-keyboard-toolbar-widget';

export class LinvoKeyboardToolbarWidget extends WidgetComponent<RootBlockModel> {
  ...
  override render() {
    ...
    return html`<linvo-portal
      .shadowDom=${false}
      .template=${html`<linvo-keyboard-toolbar
...
declare global {
  interface HTMLElementTagNameMap {
    [LINVO_KEYBOARD_TOOLBAR_WIDGET]: LinvoKeyboardToolbarWidget;
  }
}
