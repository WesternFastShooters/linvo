...
import type { ExtensionType, Schema, Workspace } from '@linvo/store';
...
export class ImportDoc extends WithDisposable(LitElement) {
  ...
  private _openLearnImportLink(event: MouseEvent) {
    event.stopPropagation();
    window.open(
      'https://linvo.pro/blog/import-your-data-from-notion-into-linvo',
      '_blank'
    );
  }
  ...
  override render() {
    ...
    return html`
      ...
      <div class="container">
        ...
        <div>
          Linvo will gradually support more file formats for import.
          <a
            href="https://community.linvo.pro/c/feature-requests/import-export"
            target="_blank"
            >Provide feedback.</a
          >
        </div>
        ...
        <div class="button-container">
          ...
          >
            ...
            >
              ${HelpIcon}
              <linvo-tooltip>
                Learn how to import your Notion pages into Linvo.
              </linvo-tooltip>
            </div>
          </icon-button>
        ...
        <!-- <div class="footer">
        <div>Migrate from other versions of Linvo?</div>
      </div> -->
      </div>
    `;
  }
