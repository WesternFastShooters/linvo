...
export class LinvoLinkedDocWidget extends WidgetComponent<RootBlockModel> {
  ...
  private readonly _renderLinkedDocMenu = () => {
    ...
    return html`<linvo-mobile-linked-doc-menu
  ...
  private readonly _renderLinkedDocPopover = () => {
    return html`<linvo-linked-doc-popover
      .context=${this._context}
    ></linvo-linked-doc-popover>`;
  };
...
declare global {
  interface HTMLElementTagNameMap {
    [LINVO_LINKED_DOC_WIDGET]: LinvoLinkedDocWidget;
  }
}
