...
import { getSelectionRectsCommand } from '@linvo/linvo-shared/commands';
import { EMBED_BLOCK_MODEL_LIST } from '@linvo/linvo-shared/consts';
...
import type { BaseSelection, UserInfo } from '@linvo/store';
...
export const LINVO_DOC_REMOTE_SELECTION_WIDGET =
  'linvo-doc-remote-selection-widget';

export class LinvoDocRemoteSelectionWidget extends WidgetComponent {
                ...
                >
                  <div
                    style="${styleMap({
                      ...
                      maxWidth: '160px',
                      padding: '0 3px',
                      border: '1px solid var(--linvo-pure-black-20)',
...
declare global {
  interface HTMLElementTagNameMap {
    [LINVO_DOC_REMOTE_SELECTION_WIDGET]: LinvoDocRemoteSelectionWidget;
  }
}
