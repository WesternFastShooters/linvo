...
export const LINVO_EDGELESS_REMOTE_SELECTION_WIDGET =
  'linvo-edgeless-remote-selection-widget';
...
export class EdgelessRemoteSelectionWidget extends WidgetComponent<RootBlockModel> {
  ...
  override render() {
    ...
    return html`
      <div class="linvo-edgeless-remote-selection">${rects}${cursors}</div>
    `;
  }
...
declare global {
  interface HTMLElementTagNameMap {
    [LINVO_EDGELESS_REMOTE_SELECTION_WIDGET]: EdgelessRemoteSelectionWidget;
  }
}
