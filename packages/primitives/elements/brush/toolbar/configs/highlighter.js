...
import { adjustColorAlpha, keepColor, packColor, } from '@linvo-ui/components/color-picker';
import { DEFAULT_HIGHLIGHTER_LINE_WIDTH, DefaultTheme, HIGHLIGHTER_LINE_WIDTHS, HighlighterElementModel, resolveColor, } from '@linvo-core/content';
...
export const highlighterToolbarExtension = ToolbarModuleExtension({
    id: BlockFlavourIdentifier('linvo:surface:highlighter'),
