...
import { type ConnectorElementModel, ConnectorMode, type LocalConnectorElementModel } from '@linvo-core/content';
import type { BezierCurveParameters, IVec, PointLocation } from '@linvo-core/global/gfx';
