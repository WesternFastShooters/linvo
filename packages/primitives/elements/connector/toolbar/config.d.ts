import { type ToolbarContext, type ToolbarGenericAction } from '@linvo-core/shared/services';
...
export declare const connectorToolbarExtension: import("@linvo-core/composition").ExtensionType;
