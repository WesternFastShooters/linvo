...
import { packColor, } from '@linvo-ui/components/color-picker';
import { createTextActions, normalizeTextBound, } from '@linvo-primitives/text';
import { ConnectorElementModel, ConnectorMode, DEFAULT_FRONT_ENDPOINT_STYLE, DEFAULT_REAR_ENDPOINT_STYLE, DefaultTheme, LineWidth, PointStyle, resolveColor, StrokeStyle, } from '@linvo-core/content';
import { ToolbarModuleExtension, } from '@linvo-core/shared/services';
import { getMostCommonResolvedValue, getMostCommonValue, } from '@linvo-core/shared/utils';
import { getRootBlock, LINE_STYLE_LIST, renderMenu, } from '@linvo-ui/edgeless-toolbar';
import { Bound } from '@linvo-core/global/gfx';
import { AddTextIcon, ConnectorCIcon, ConnectorEIcon, ConnectorLIcon, EndPointArrowIcon, EndPointCircleIcon, EndPointDiamondIcon, EndPointTriangleIcon, FlipDirectionIcon, StartPointArrowIcon, StartPointCircleIcon, StartPointDiamondIcon, StartPointIcon, StartPointTriangleIcon, } from '@icons/lit';
...
export const connectorToolbarExtension = ToolbarModuleExtension({
    id: BlockFlavourIdentifier('linvo:surface:connector'),
