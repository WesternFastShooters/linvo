import { LocalShapeElementModel, type MindmapElementModel, type MindmapNode } from '@linvo-core/content';
import { type BoxSelectionContext, GfxElementModelView } from '@linvo-core/std/gfx';
...
export declare const MindMapInteraction: import("@linvo-core/composition").ExtensionType;
