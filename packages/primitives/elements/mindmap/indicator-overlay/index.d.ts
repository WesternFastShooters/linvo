...
import { ConnectorMode, LayoutType, type MindmapElementModel, type MindmapNode } from '@linvo-core/content';
import { type Bound, type IVec } from '@linvo-core/global/gfx';
export declare class MindMapIndicatorOverlay extends Overlay {
    ...
    get themeService(): import("@linvo-core/shared/services").ThemeService;
