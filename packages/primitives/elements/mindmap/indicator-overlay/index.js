...
import { PathGenerator } from '@linvo-primitives/connector';
import { ConnectorMode, LayoutType, } from '@linvo-core/content';
import { ThemeProvider } from '@linvo-core/shared/services';
import { isVecZero, PointLocation, toRadian, Vec, } from '@linvo-core/global/gfx';
import last from 'lodash-es/last';
import { NODE_HORIZONTAL_SPACING, NODE_VERTICAL_SPACING } from '../element-view/mindmap-layout';
export class MindMapIndicatorOverlay extends Overlay {
    ...
    render(ctx) {
        ...
        const color = this.themeService.getColorValue('--linvo-primary-color', '#1E96EB', true);
