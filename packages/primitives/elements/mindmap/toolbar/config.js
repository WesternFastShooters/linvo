import { hasGrouped } from '@linvo-primitives/shape';
import { LayoutType, MindmapElementModel, MindmapStyle, ShapeElementModel, } from '@linvo-core/content';
import { ToolbarModuleExtension, } from '@linvo-core/shared/services';
import { getMostCommonValue } from '@linvo-core/shared/utils';
import { renderMenu, } from '@linvo-ui/edgeless-toolbar';
import { RadiantIcon, RightLayoutIcon, StyleIcon } from '@icons/lit';
import { BlockFlavourIdentifier } from '@linvo-core/std';
import { MindmapStyleFour, MindmapStyleOne, MindmapStyleThree, MindmapStyleTwo, } from '../element-view';
...
export const mindmapToolbarExtension = ToolbarModuleExtension({
    id: BlockFlavourIdentifier('linvo:surface:mindmap'),
    config: mindmapToolbarConfig,
});
export const shapeMindmapToolbarExtension = ToolbarModuleExtension({
    id: BlockFlavourIdentifier('custom:linvo:surface:shape'),
