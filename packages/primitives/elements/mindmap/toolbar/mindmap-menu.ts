...
import { EmptyTool } from '@linvo-primitives/pointer';
import type { MindmapStyle } from '@linvo-core/content';
import {
  EditPropsStore,
  FeatureFlagService,
  TelemetryProvider,
...
import { ErrorCode } from '@linvo-core/global/exceptions';
...
import { modelContext, stdContext } from '@linvo-core/std';
...
import { getMindMaps, type ToolbarMindmapItem } from './assets';
import { importMindMapIcon } from './icons';
import { MindMapPlaceholder } from './mindmap-importing-placeholder';
...
export class EdgelessMindmapMenu extends EdgelessToolbarToolMixin(
  ...
  private _importMindMapEntry() {
    ...
    return html`<div class="mindmap-item">
      ...
      <linvo-tooltip tip-position="top" .offset=${12}>
