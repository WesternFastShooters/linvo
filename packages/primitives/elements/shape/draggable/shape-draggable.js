...
import { CanvasElementType, DefaultTool, EdgelessCRUDIdentifier, } from '@linvo-core/block-surface';
import { getShapeRadius, getShapeType, ShapeType, } from '@linvo-core/content';
import { EditPropsStore, TelemetryProvider, ThemeProvider, ViewportElementProvider, } from '@linvo-core/shared/services';
import { EdgelessDraggableElementController, EdgelessToolbarToolMixin, } from '@linvo-ui/edgeless-toolbar';
...
import { ellipseSvg, roundedSvg, triangleSvg } from '../toolbar/icons';
import { buildVariablesObject } from './utils';
const shapes = [];
