import { getFontString, getLineHeight, getLineWidth, getTextWidth, measureTextInDOM, wrapText, wrapTextDeltas, } from '@linvo-primitives/text';
...
export function drawGeneralShape(ctx, shapeModel, renderer, filled, fillColor, strokeColor) {
    ...
    if (isPresetShapeType(shapeModel.shapeType)) {
        drawPresetShapeUnderlay(ctx, shapeModel.shapeType, xywh, shapeModel.strokeWidth);
    }
