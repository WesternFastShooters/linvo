...
import { createTextActions } from '@linvo-primitives/text';
import { DefaultTheme, FontFamily, getShapeName, getShapeRadius, getShapeType, isTransparent, LineWidth, MindmapElementModel, resolveColor, ShapeElementModel, ShapeStyle, ShapeType, StrokeStyle, } from '@linvo-core/content';
import { ToolbarModuleExtension, } from '@linvo-core/shared/services';
import { getMostCommonValue } from '@linvo-core/shared/utils';
...
export const shapeToolbarExtension = ToolbarModuleExtension({
    id: BlockFlavourIdentifier('linvo:surface:shape'),
