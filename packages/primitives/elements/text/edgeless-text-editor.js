...
import { CanvasElementType, DefaultTool, EdgelessCRUDIdentifier, getSurfaceBlock, TextUtils, } from '@linvo-core/block-surface';
import { DefaultTheme, TextElementModel } from '@linvo-core/content';
...
import { bindSurfaceText, createSurfaceText, PlainTextEditor, } from './surface-text';
...
let EdgelessTextEditor = (() => {
    ...
    .edgeless-text-editor {
      ...
      border: ${EdgelessTextEditor.BORDER_WIDTH}px solid
        var(--linvo-primary-color, #1e96eb);
      border-radius: 4px;
    ...
    .edgeless-text-editor plain-text-editor {
      display: block;
    }
  ...
  `; }
        ...
        render() {
            ...
            const textController = bindSurfaceText(text);
            return html `<div
      style=${styleMap({
    ...
    >
      <plain-text-editor
        .text=${textController}
        .wrapMode=${hasMaxWidth ? 'wrap' : 'nowrap'}
        style=${isEmpty
                ? styleMap({
                    position: 'absolute',
                    left: 0,
      ...
      ${isEmpty
        ...
        constructor() {
            ...
            this.#plainTextEditor_accessor_storage = (__runInitializers(this, _element_extraInitializers), __runInitializers(this, _plainTextEditor_initializers, void 0));
