import type { FontFamily, FontStyle, FontWeight, TextElementModel } from '@linvo-core/content';
import type { Bound } from '@linvo-core/global/gfx';
import type { SurfaceTextLike } from '../surface-text';
...
export declare function wrapTextDeltas(text: SurfaceTextLike, font: string, w: number): TextDelta[];
