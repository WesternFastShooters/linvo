import { EdgelessCRUDIdentifier, TextUtils, } from '@linvo-core/block-surface';
import { packColor, } from '@linvo-ui/components/color-picker';
import { EditorChevronDown } from '@linvo-ui/components/toolbar';
import { DefaultTheme, FontFamily, FontStyle, FontWeight, resolveColor, TextAlign, } from '@linvo-core/content';
import { getMostCommonResolvedValue, getMostCommonValue, } from '@linvo-core/shared/utils';
import { renderCurrentMenuItemWith, renderMenu, } from '@linvo-ui/edgeless-toolbar';
import { TextAlignCenterIcon, TextAlignLeftIcon, TextAlignRightIcon, } from '@icons/lit';
    ...
    return [
        ...
        },
        {
            ...
            content(ctx) {
                ...
                return html `<linvo-size-dropdown-menu
          @select=${onPick}
          .label="${'Font size'}"
          .sizes=${FONT_SIZE_LIST}
          .size$=${fontSize$}
        ></linvo-size-dropdown-menu>`;
            },
        },
        {
            id: 'e.alignment',
