...
import { getAttachmentFileIcon, LoadingIcon, } from '@linvo-ui/components/icons';
...
import { AttachmentBlockStyles, } from '@linvo-core/content';
import { BlockCommentManager, CitationProvider, DocModeProvider, FileSizeLimitProvider, TelemetryProvider, } from '@linvo-core/shared/services';
import { formatSize, openSingleFileWith, } from '@linvo-core/shared/utils';
import { AttachmentIcon, ResetIcon, UpgradeIcon, WarningIcon, } from '@icons/lit';
import { BlockSelection } from '@linvo-core/std';
import { nanoid, Slice } from '@linvo-core/store';
...
let AttachmentBlockComponent = (() => {
    ...
    var AttachmentBlockComponent = class extends _classSuper {
        ...
        <button
          class="linvo-attachment-content-button"
          @click=${(event) => {
    ...
    `;
            ...
            this.renderEmbedView = () => {
                ...
                return html `
      <div class="linvo-attachment-embed-container">
      ...
      ${when(enabled, () => {
                    ...
                    return html `
          <linvo-resource-status
            class="linvo-attachment-embed-status"
            .message=${message}
    ...
    `;
            ...
            this._renderCitation = () => {
                ...
                return html `<linvo-citation-card
      .icon=${icon}
      .citationTitle=${name}
    ...
    ></linvo-citation-card>`;
      ...
      <div class=${classMap(classInfo)}>
        <div class="linvo-attachment-content">
          <div class="linvo-attachment-content-title">
            <div class="linvo-attachment-content-title-icon">${icon}</div>
            <div class="linvo-attachment-content-title-text truncate">
              ${title}
            </div>
          </div>

          <div class="linvo-attachment-content-description">
            <div class="linvo-attachment-content-info truncate">
              ${description}
            </div>
            ${choose(state, [
        ...
        <div class="linvo-attachment-banner">${kind}</div>
      </div>
    `;
        }
      ...
      <div class=${classMap(classInfo)}>
        ...
        <div class="linvo-attachment-banner">
          ${kind}
          ${choose(state, [
                ['error', () => this.renderNormalButton(needUpload)],
                ['error:oversize', this.renderUpgradeButton],
    ...
    `;
      ...
      <div
        class=${classMap({
                'linvo-attachment-container': true,
