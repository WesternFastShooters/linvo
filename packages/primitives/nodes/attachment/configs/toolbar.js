...
import { AttachmentBlockModel, defaultAttachmentProps, } from '@linvo-core/content';
import { EMBED_CARD_HEIGHT, EMBED_CARD_WIDTH, } from '@linvo-core/shared/consts';
import { ActionPlacement, blockCommentToolbarButton, ToolbarModuleExtension, } from '@linvo-core/shared/services';
import { getBlockProps } from '@linvo-core/shared/utils';
import { Bound } from '@linvo-core/global/gfx';
import { CaptionIcon, CopyIcon, DeleteIcon, DownloadIcon, DuplicateIcon, EditIcon, ReplaceIcon, ResetIcon, } from '@icons/lit';
...
export const attachmentViewDropdownMenu = {
    ...
    content(ctx) {
        ...
        return html `<linvo-view-dropdown-menu
      @toggle=${onToggle}
      .actions=${actions.value}
      .context=${ctx}
      .viewType$=${viewType$}
    ></linvo-view-dropdown-menu>`;
    },
};
const replaceAction = {
    id: 'c.replace',
    ...
    actions: [
        attachmentViewDropdownMenu,
        {
            ...
            content(ctx) {
                ...
                return html `${keyed(model, html `<linvo-card-style-dropdown-menu
            @toggle=${onToggle}
            .actions=${actions}
            .context=${ctx}
            .style$=${style$}
          ></linvo-card-style-dropdown-menu>`)}`;
            },
        },
        {
            ...replaceAction,
