import { reassociateConnectorsCommand } from '@linvo-core/block-surface';
...
import { BlockFlavourIdentifier, BlockSelection } from '@linvo-core/std';
import { type ExtensionType, Slice, Text } from '@linvo-core/store';
...
const previewAction = {
  ...
  content(ctx) {
    ...
    return html`<linvo-link-preview .url=${url}></linvo-link-preview>`;
  },
    ...
    actions: [
        ...
        actions: [
          {
            ...
            run(ctx) {
              ...
              ctx.store.addBlock('linvo:paragraph', { text }, parent, index);
          ...
          },
          {
            ...
            run(ctx) {
              ...
              let flavour = 'linvo:embed-iframe';
      ...
      } satisfies ToolbarActionGroup<ToolbarAction>,
      {
        ...
        content(ctx) {
          ...
          return html`${keyed(
            model,
            html`<linvo-card-style-dropdown-menu
              @toggle=${onToggle}
              .actions=${actions}
              .context=${ctx}
