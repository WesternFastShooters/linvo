...
export const styles = css`
  ...
  .linvo-embed-figma img,
  .linvo-embed-figma object,
  .linvo-embed-figma svg {
    width: 100%;
    height: 100%;
    object-fit: cover;
    border-radius: 4px;
  ...
  .linvo-embed-figma-iframe-container {
    height: 100%;
    position: relative;
  }

  .linvo-embed-figma-iframe-container > iframe {
    width: 100%;
    height: 100%;
    border-radius: 4px;
    border: none;
  ...
  .linvo-embed-figma-iframe-overlay {
    position: absolute;
    top: 0;
    left: 0;
    width: 100%;
  ...
  .linvo-embed-figma-iframe-overlay.hide {
    display: none;
  }

  .linvo-embed-figma-content {
    display: block;
    flex-direction: column;
    width: 100%;
    height: fit-content;
  ...
  .linvo-embed-figma-content-header {
    display: flex;
    flex-direction: row;
    gap: 8px;
    align-items: center;
  ...
  .linvo-embed-figma-content-title-icon {
    display: flex;
    width: 20px;
    height: 20px;
  ...
  .linvo-embed-figma-content-title-icon img,
  .linvo-embed-figma-content-title-icon object,
  .linvo-embed-figma-content-title-icon svg {
    width: 20px;
    height: 20px;
    fill: var(--linvo-background-primary-color);
  }

  .linvo-embed-figma-content-title-text {
    flex: 1 0 0;
  ...
  .linvo-embed-figma-content-description {
    height: 40px;
  ...
  .linvo-embed-figma-content-description::after {
    content: '...';
    position: absolute;
    right: 0;
    bottom: 0;
  ...
  .linvo-embed-figma-content-url > span {
    display: -webkit-box;
    -webkit-line-clamp: 1;
    -webkit-box-orient: vertical;
  ...
  .linvo-embed-figma-content-url:hover > span {
    color: var(--linvo-link-color);
  }
  .linvo-embed-figma-content-url:hover .open-icon {
    fill: var(--linvo-link-color);
  }

  .linvo-embed-figma-content-url-icon {
    display: flex;
    align-items: center;
    justify-content: center;
    width: 12px;
  ...
  .linvo-embed-figma-content-url-icon svg {
    height: 12px;
    width: 12px;
    fill: ${unsafeCSSVarV2('icon/primary')};
  }

  .linvo-embed-figma-block.selected {
    .linvo-embed-figma-content-url > span {
      color: var(--linvo-link-color);
    }
    .linvo-embed-figma-content-url .open-icon {
      fill: var(--linvo-link-color);
    }
  }
`;
