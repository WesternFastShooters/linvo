...
export const styles = css`
  .linvo-embed-github-block {
    container: linvo-embed-github-block / inline-size;
  ...
  .linvo-embed-github-content-title {
    display: flex;
    min-height: 22px;
    flex-direction: row;
    gap: 8px;
  ...
  .linvo-embed-github-content-title-icons {
    display: flex;
  ...
  .linvo-embed-github-content-title-icons img,
  .linvo-embed-github-content-title-icons object,
  .linvo-embed-github-content-title-icons svg {
    width: 16px;
    height: 16px;
    color: var(--linvo-pure-white);
  }

  .linvo-embed-github-content-title-site-icon {
    display: flex;
    width: 16px;
    height: 16px;
    justify-content: center;
    ...
    .github-icon {
      fill: var(--linvo-black);
      color: var(--linvo-black);
    }
  }

  .linvo-embed-github-content-title-status-icon {
    display: flex;
    align-items: center;
    gap: 4px;
    padding: 3px 6px;
  ...
  .linvo-embed-github-content-title-status-icon.issue.open {
    background: #238636;
  }
  .linvo-embed-github-content-title-status-icon.issue.closed.success {
    background: #8957e5;
  }
  .linvo-embed-github-content-title-status-icon.issue.closed.failure {
    background: #6e7681;
  }
  .linvo-embed-github-content-title-status-icon.pr.open {
    background: #238636;
  }
  .linvo-embed-github-content-title-status-icon.pr.draft {
    background: #6e7681;
  }
  .linvo-embed-github-content-title-status-icon.pr.merged {
    background: #8957e5;
  }
  .linvo-embed-github-content-title-status-icon.pr.closed {
    background: #c03737;
  }

  .linvo-embed-github-content-title-status-icon > svg {
    height: 16px;
    width: 16px;
    padding: 2px;
  }

  .linvo-embed-github-content-title-status-icon > span {
    padding: 0px 1.5px;
  }

  .linvo-embed-github-content-title-text {
    display: -webkit-box;
    -webkit-line-clamp: 1;
  ...
  .linvo-embed-github-content-description {
    display: -webkit-box;
    -webkit-line-clamp: 2;
    -webkit-box-orient: vertical;
  ...
  .linvo-embed-github-content-assignees {
    display: none;
  }

  .linvo-embed-github-content-url {
    display: flex;
    align-items: center;
  ...
  .linvo-embed-github-content-url > span {
    display: -webkit-box;
    -webkit-line-clamp: 1;
    -webkit-box-orient: vertical;
  ...
  .linvo-embed-github-content-url:hover > span {
    color: var(--linvo-link-color);
  }
  .linvo-embed-github-content-url:hover .open-icon {
    fill: var(--linvo-link-color);
  }

  .linvo-embed-github-content-url-icon {
    display: flex;
    align-items: center;
    justify-content: center;
    width: 12px;
  ...
  .linvo-embed-github-content-url-icon .open-icon {
    height: 12px;
    width: 12px;
    fill: var(--linvo-text-secondary-color);
  }

  .linvo-embed-github-banner {
    margin: 12px 0px 0px 12px;
    width: 204px;
    height: 102px;
  }

  .linvo-embed-github-banner img,
  .linvo-embed-github-banner object,
  .linvo-embed-github-banner svg {
    width: 204px;
    height: 102px;
    object-fit: cover;
    border-radius: 4px;
  ...
  .linvo-embed-github-block.loading {
    .linvo-embed-github-content-title-text {
      color: var(--linvo-placeholder-color);
    }
  }

  .linvo-embed-github-block.selected {
    .linvo-embed-github-content-url > span {
      color: var(--linvo-link-color);
    }
    .linvo-embed-github-content-url .open-icon {
      fill: var(--linvo-link-color);
    }
  }

  .linvo-embed-github-block.list {
    .linvo-embed-github-content {
      width: 100%;
      flex-direction: row;
      align-items: center;
    ...
    .linvo-embed-github-content-repo {
      display: none;
    }

    .linvo-embed-github-content-date {
      display: none;
    }
  ...
  .linvo-embed-github-block.vertical {
    ...
    .linvo-embed-github-content-assignees-text {
      display: -webkit-box;
      -webkit-line-clamp: 1;
      -webkit-box-orient: vertical;
    ...
    .linvo-embed-github-content-assignees-text.label {
      width: 72px;
      color: var(--linvo-text-primary-color);
      font-weight: 600;
    }

    .linvo-embed-github-content-assignees-text.users {
      width: calc(100% - 72px);
      word-break: break-all;
      white-space: normal;
      overflow: hidden;
    ...
    .linvo-embed-github-content-assignees-text-users.user {
      color: var(--linvo-link-color);
      cursor: pointer;
    }

    .linvo-embed-github-content-assignees-text-users.placeholder {
      color: var(--linvo-placeholder-color);
    }
  ...
  @container linvo-embed-github-block (width < 375px) {
    .linvo-embed-github-content {
      width: 100%;
    }

    .linvo-embed-github-block:not(.edgeless) .linvo-embed-github-banner {
      display: none;
    }
  }
`;
