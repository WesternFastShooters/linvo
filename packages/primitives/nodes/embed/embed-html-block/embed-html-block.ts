import type { EmbedHtmlModel, EmbedHtmlStyles } from '@linvo-core/content';
...
import { HtmlIcon, styles } from './styles';
  ...
  override renderBlock(): unknown {
    ...
    return this.renderEmbed(() => {
      if (!this.model.props.html) {
        return html` <div class="linvo-html-empty">Empty</div>`;
      }
      return html`
        <div
          class=${classMap({
            'linvo-embed-html-block': true,
        ...
        >
          <div class="linvo-embed-html">
            <div class="linvo-embed-html-iframe-container">
              ...
              <div
                class=${classMap({
                  'linvo-embed-html-iframe-overlay': true,
          ...
          <div class="linvo-embed-html-title">
            <div class="linvo-embed-html-title-icon">${HtmlIcon}</div>

            <div class="linvo-embed-html-title-text">${titleText}</div>
          </div>
        </div>
      `;
    });
