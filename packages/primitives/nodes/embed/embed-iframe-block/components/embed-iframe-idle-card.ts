...
export class EmbedIframeIdleCard extends WithDisposable(LitElement) {
  static override styles = css`
    ...
    .linvo-embed-iframe-idle-card {
      container: linvo-embed-iframe-idle-card / size;
    ...
    .linvo-embed-iframe-idle-card:hover {
      cursor: pointer;
    }

    .linvo-embed-iframe-idle-card.horizontal {
      flex-direction: row;
    ...
    .linvo-embed-iframe-idle-card.vertical {
      ...
      @container linvo-embed-iframe-idle-card (height < 180px) {
        .icon {
          display: none;
        }
      }
  ...
  override render() {
    ...
    const cardClasses = classMap({
      'linvo-embed-iframe-idle-card': true,
    ...
    return html`
      <div class=${cardClasses} style=${cardStyle}>
        ...
        <span class="text">
          Add a protected web preview node
        </span>
      </div>
    `;
  }
