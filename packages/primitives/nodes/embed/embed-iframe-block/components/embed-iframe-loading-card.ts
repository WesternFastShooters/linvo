...
export class EmbedIframeLoadingCard extends LitElement {
  static override styles = css`
    ...
    .linvo-embed-iframe-loading-card {
      container: linvo-embed-iframe-loading-card / size;
      display: flex;
      ...
      @container linvo-embed-iframe-loading-card (width < 360px) {
        .loading-banner {
          display: none;
        }
      }
    ...
    .linvo-embed-iframe-loading-card.horizontal {
      flex-direction: row;
    ...
    .linvo-embed-iframe-loading-card.vertical {
      ...
      @container linvo-embed-iframe-loading-card (height < 240px) {
        .loading-banner {
          display: none;
        }
      }
  ...
  override render() {
    ...
    const cardClasses = classMap({
      'linvo-embed-iframe-loading-card': true,
