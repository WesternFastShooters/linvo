...
import type { EmbedCardStyle, EmbedProps } from '@linvo-core/content';
import {
  EMBED_CARD_HEIGHT,
...
import { findAncestorModel } from '@linvo-core/shared/utils';
import type { BlockService } from '@linvo-core/std';
import {
