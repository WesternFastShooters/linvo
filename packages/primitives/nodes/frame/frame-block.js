...
import { OverlayIdentifier } from '@linvo-core/block-surface';
import { DefaultTheme, FrameBlockSchema, isTransparent, } from '@linvo-core/content';
...
import { getTopElements, GfxViewInteractionExtension, } from '@linvo-core/std/gfx';
...
let FrameBlockComponent = (() => {
    ...
    `;
        ...
        accessor showBorder = __runInitializers(this, _showBorder_initializers, true);
        constructor() {
            super(...arguments);
