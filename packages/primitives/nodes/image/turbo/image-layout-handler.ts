import type { Rect } from '@linvo-core/turbo-renderer';
import {
  BlockLayoutHandlerExtension,
  BlockLayoutHandlersIdentifier,
} from '@linvo-core/turbo-renderer';
import type { Container } from '@linvo-core/composition/di';
import type { EditorHost, GfxBlockComponent } from '@linvo-core/std';
import { clientToModelCoord, type ViewportRecord } from '@linvo-core/std/gfx';
