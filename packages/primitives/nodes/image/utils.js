import { autoResizeElementsCommand } from '@linvo-core/block-surface';
import { toast } from '@linvo-ui/components/toast';
import { ImageBlockSchema, } from '@linvo-core/content';
import { FileSizeLimitProvider, NativeClipboardProvider, } from '@linvo-core/shared/services';
import { convertToPng, formatSize, getBlockProps, isInsidePageEditor, readImageSize, transformModel, withTempBlobData, } from '@linvo-core/shared/utils';
...
const DEFAULT_ATTACHMENT_NAME = 'linvo-attachment';
...
export async function turnImageIntoCardView(block) {
    ...
    if (!doc.schema.flavourSchemaMap.has('linvo:attachment')) {
    ...
    transformModel(model, 'linvo:attachment', attachmentProp);
}
