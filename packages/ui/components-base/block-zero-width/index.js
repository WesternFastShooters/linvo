...
import { TextSelection } from '@linvo-core/std';
  ...
  `; }
        ...
        constructor() {
            ...
            this._handleClick = (e) => {
                ...
                if (nextBlock?.flavour !== 'linvo:paragraph') {
                    const [paragraphId] = this.block.store.addSiblingBlocks(this.block.model, [{ flavour: 'linvo:paragraph' }]);
