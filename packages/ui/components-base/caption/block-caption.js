...
import { modelContext, ShadowlessElement, stdContext, storeContext, TextSelection, } from '@linvo-core/std';
  ...
  `; }
        ...
        _onCaptionKeydown(event) {
            ...
            if (event.key === 'Enter') {
                ...
                const id = doc.addBlock('linvo:paragraph', { text: new Text(nextBlockText) }, parent, index + 1);
                const std = this.std;
