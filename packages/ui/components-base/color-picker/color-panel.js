...
import { DefaultTheme, resolveColor } from '@linvo-core/content';
import { unsafeCSSVarV2 } from '@linvo-core/shared/theme';
import { ColorEvent } from '@linvo-core/shared/utils';
...
let EdgelessColorButton = (() => {
    ...
    :host([active])::after {
      border: 1.5px solid var(--linvo-primary-color);
    }
  `; }
        get preprocessColor() {
      ...
      ${additionIcon}
        ...
        accessor color = (__runInitializers(this, _active_extraInitializers), __runInitializers(this, _color_initializers, void 0));
        accessor hollowCircle = (__runInitializers(this, _color_extraInitializers), __runInitializers(this, _hollowCircle_initializers, false));
        accessor label = (__runInitializers(this, _hollowCircle_extraInitializers), __runInitializers(this, _label_initializers, undefined));
        accessor theme = (__runInitializers(this, _label_extraInitializers), __runInitializers(this, _theme_initializers, void 0));
        constructor() {
            super(...arguments);
...
let EdgelessColorPanel = (() => {
  ...
  `; }
    ...
    `;
        ...
        accessor hasTransparent = __runInitializers(this, _hasTransparent_initializers, true);
        accessor hollowCircle = (__runInitializers(this, _hasTransparent_extraInitializers), __runInitializers(this, _hollowCircle_initializers, false));
        accessor palettes = (__runInitializers(this, _hollowCircle_extraInitializers), __runInitializers(this, _palettes_initializers, DefaultTheme.Palettes));
        accessor theme = (__runInitializers(this, _palettes_extraInitializers), __runInitializers(this, _theme_initializers, void 0));
        accessor value = (__runInitializers(this, _theme_extraInitializers), __runInitializers(this, _value_initializers, null));
        accessor columns = (__runInitializers(this, _value_extraInitializers), __runInitializers(this, _columns_initializers, undefined));
        constructor() {
            super(...arguments);
...
let EdgelessTextColorIcon = (() => {
  ...
  `; }
    ...
    `;
        ...
        accessor color = __runInitializers(this, _color_initializers, void 0);
        constructor() {
            super(...arguments);
