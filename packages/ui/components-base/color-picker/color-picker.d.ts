...
import type { Hsva, ModeRgba, ModeTab, ModeType, NavType, PickColorEvent, Point, Rgb } from './types';
declare const EdgelessColorPicker_base: typeof LitElement & import("@linvo-core/global/utils").Constructor<import("@linvo-core/global/lit").DisposableClass>;
export declare class EdgelessColorPicker extends EdgelessColorPicker_base {
    ...
    accessor rgba$: import("@preact/signals-core").ReadonlySignal<import("./types").Rgba>;
}
export {};
