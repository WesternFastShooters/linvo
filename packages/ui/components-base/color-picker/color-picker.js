...
import { on, once, stopPropagation } from '@linvo-core/shared/utils';
...
import { AREA_CIRCLE_R, MATCHERS, SLIDER_CIRCLE_R } from './consts';
import { TransparentIcon } from './icons';
import { COLOR_PICKER_STYLE } from './styles';
import { bound01, defaultHsva, eq, hsvaToHex8, hsvaToRgba, linearGradientAt, parseHexToHsva, renderCanvas, rgbaToHex8, rgbaToHsva, rgbToHex, rgbToHsv, } from './utils';
const TABS = [
...
let EdgelessColorPicker = (() => {
    ...
    `;
        ...
        accessor alphaControl = __runInitializers(this, _alphaControl_initializers, void 0);
        accessor alphaPosX$ = (__runInitializers(this, _alphaControl_extraInitializers), signal(0));
        ...
        accessor canvas = __runInitializers(this, _canvas_initializers, void 0);
        accessor colors = (__runInitializers(this, _canvas_extraInitializers), __runInitializers(this, _colors_initializers, { type: 'normal' }));
        accessor dark$ = (__runInitializers(this, _colors_extraInitializers), computed(() => this.modes$.value[2]));
        // #ffffff
        ...
        accessor hsva$ = signal(defaultHsva());
        accessor hue$ = signal({ r: 0, g: 0, b: 0 });
        accessor hueControl = __runInitializers(this, _hueControl_initializers, void 0);
        accessor huePosX$ = (__runInitializers(this, _hueControl_extraInitializers), signal(0));
        ...
        accessor light$ = computed(() => this.modes$.value[1]);
        accessor mode$ = computed(() => {
            const modeType = this.modeType$.value;
            return this.modes$.value.find(mode => mode.type === modeType);
        });
        accessor modes$ = signal([
            { type: 'normal', name: 'Normal', hsva: defaultHsva() },
            { type: 'light', name: 'Light', hsva: defaultHsva() },
            { type: 'dark', name: 'Dark', hsva: defaultHsva() },
        ]);
        accessor modeType$ = signal('normal');
        accessor navType$ = signal('colors');
        accessor paletteControl = __runInitializers(this, _paletteControl_initializers, void 0);
        accessor palettePos$ = (__runInitializers(this, _paletteControl_extraInitializers), signal({ x: 0, y: 0 }));
        ...
        accessor pick = __runInitializers(this, _pick_initializers, void 0);
        accessor rgba$ = (__runInitializers(this, _pick_extraInitializers), computed(() => hsvaToRgba(this.hsva$.value)));
    };
})();
