...
let MenuDivider = (() => {
  ...
  `; }
    ...
    ></div>`;
        ...
        accessor dividerMargin = __runInitializers(this, _dividerMargin_initializers, 7);
        accessor vertical = (__runInitializers(this, _dividerMargin_extraInitializers), __runInitializers(this, _vertical_initializers, false));
        constructor() {
            super(...arguments);
