...
import {} from '@linvo-core/global/gfx';
...
let DropIndicator = (() => {
  ...
  `; }
        render() {
            ...
            return html `<div class="linvo-drop-indicator" style=${style}></div>`;
        }
        accessor rect = __runInitializers(this, _rect_initializers, null);
        accessor zIndex = (__runInitializers(this, _rect_extraInitializers), __runInitializers(this, _zIndex_initializers, 2));
        constructor() {
            super(...arguments);
