import { NoteBlockModel } from '@linvo-core/content';
import { calcDropTarget, getClosestBlockComponentByPoint, isInsidePageEditor, matchModels, } from '@linvo-core/shared/utils';
...
export class FileDropExtension extends LifeCycleWatcher {
    ...
    getDropTargetModel(model) {
        ...
        if (!lastNote || !matchModels(lastNote, [NoteBlockModel])) {
            const newNoteId = this.doc.addBlock('linvo:note', {}, rootModel.id);
        ...
        if (lastItem) {
            ...
            const newParagraphId = this.doc.addBlock('linvo:paragraph', {}, lastNote, 0);
