...
let EdgelessLineStylesPanel = (() => {
  ...
  `; }
    ...
    `;
        ...
        accessor lineStyle = __runInitializers(this, _lineStyle_initializers, void 0);
        accessor lineSize = (__runInitializers(this, _lineStyle_extraInitializers), __runInitializers(this, _lineSize_initializers, LineWidth.Two));
        accessor lineStyles = (__runInitializers(this, _lineSize_extraInitializers), __runInitializers(this, _lineStyles_initializers, [
            StrokeStyle.Solid,
            StrokeStyle.Dash,
            StrokeStyle.None,
        ]));
