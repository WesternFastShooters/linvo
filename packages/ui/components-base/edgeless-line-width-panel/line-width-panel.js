...
import { BRUSH_LINE_WIDTHS, LineWidth } from '@linvo-core/content';
...
let EdgelessLineWidthPanel = (() => {
    ...
    ></linvo-slider>`;
        ...
        accessor disabled = __runInitializers(this, _disabled_initializers, false);
        accessor hasTooltip = (__runInitializers(this, _disabled_extraInitializers), __runInitializers(this, _hasTooltip_initializers, true));
        accessor lineWidths = (__runInitializers(this, _hasTooltip_extraInitializers), __runInitializers(this, _lineWidths_initializers, BRUSH_LINE_WIDTHS));
        accessor selectedSize = (__runInitializers(this, _lineWidths_extraInitializers), __runInitializers(this, _selectedSize_initializers, LineWidth.Two));
        constructor() {
            super(...arguments);
