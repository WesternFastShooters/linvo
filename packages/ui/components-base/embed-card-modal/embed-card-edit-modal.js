...
import { EmbedSyncedDocModel, isInternalEmbedModel, } from '@linvo-core/content';
import { TelemetryProvider, } from '@linvo-core/shared/services';
import { fontSMStyle, fontXSStyle } from '@linvo-core/shared/styles';
import { unsafeCSSVarV2 } from '@linvo-core/shared/theme';
import { listenClickAway, stopPropagation, } from '@linvo-core/shared/utils';
import { SignalWatcher, WithDisposable } from '@linvo-core/global/lit';
import { nextTick } from '@linvo-core/global/utils';
import { EditorLifeCycleExtension, } from '@linvo-core/std';
...
let EmbedCardEditModal = (() => {
    ...
    .embed-card-modal-wrapper {
      ...
      box-shadow: var(--linvo-overlay-shadow);
...
function track(std, model, viewType, event, props) {
    std.getOptional(TelemetryProvider)?.track(event, {
        ...
        type: `${viewType} view`,
        category: isInternalEmbedModel(model) ? 'embed doc' : 'link',
        ...props,
    });
}
