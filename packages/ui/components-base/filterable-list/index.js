...
import { PAGE_HEADER_HEIGHT } from '@linvo-core/shared/consts';
...
import { filterableListStyles } from './styles';
export * from './types';
let FilterableListComponent = (() => {
    ...
    return class FilterableListComponent extends _classSuper {
      ...
      `;
        ...
        render() {
            ...
            return html `
      <div
        class=${classMap({ 'linvo-filterable-list': true, flipped: isFlip })}
      >
    ...
    `;
        ...
        accessor _curFocusIndex = __runInitializers(this, __curFocusIndex_initializers, 0);
        accessor _filterInput = (__runInitializers(this, __curFocusIndex_extraInitializers), __runInitializers(this, __filterInput_initializers, void 0));
        accessor _filterText = (__runInitializers(this, __filterInput_extraInitializers), __runInitializers(this, __filterText_initializers, ''));
        accessor _focussedItem = (__runInitializers(this, __filterText_extraInitializers), __runInitializers(this, __focussedItem_initializers, void 0));
        accessor abortController = (__runInitializers(this, __focussedItem_extraInitializers), __runInitializers(this, _abortController_initializers, null));
        accessor listFilter = (__runInitializers(this, _abortController_extraInitializers), __runInitializers(this, _listFilter_initializers, undefined));
        accessor options = (__runInitializers(this, _listFilter_extraInitializers), __runInitializers(this, _options_initializers, void 0));
        accessor placement = (__runInitializers(this, _options_extraInitializers), __runInitializers(this, _placement_initializers, undefined));
        constructor() {
            super(...arguments);
