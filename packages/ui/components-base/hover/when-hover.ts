import { dedupe, delayHide, delayShow } from './middlewares/basic';
import { safeBridge, safeTriangle } from './middlewares/safe-area';
import type { HoverMiddleware, WhenHoverOptions } from './types';
...
export const whenHover = (
  ...
  const addHoverListener = (element?: Element) => {
    ...
    element.addEventListener('mouseleave', onHoverChange, {
      ...
      // The issue is detailed in https://github.com/toeverything/linvo/issues/6241
      //
