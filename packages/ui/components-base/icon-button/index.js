...
let IconButton = (() => {
  ...
  `; }
      ...
      <slot name="suffix"></slot>`;
        ...
        accessor disabled = (__runInitializers(this, _active_extraInitializers), __runInitializers(this, _disabled_initializers, undefined));
        accessor height = (__runInitializers(this, _disabled_extraInitializers), __runInitializers(this, _height_initializers, null));
        accessor hover = (__runInitializers(this, _height_extraInitializers), __runInitializers(this, _hover_initializers, undefined));
        accessor size = (__runInitializers(this, _hover_extraInitializers), __runInitializers(this, _size_initializers, null));
        accessor subText = (__runInitializers(this, _size_extraInitializers), __runInitializers(this, _subText_initializers, null));
        accessor text = (__runInitializers(this, _subText_extraInitializers), __runInitializers(this, _text_initializers, null));
        accessor textElement = (__runInitializers(this, _text_extraInitializers), __runInitializers(this, _textElement_initializers, null));
        accessor width = (__runInitializers(this, _textElement_extraInitializers), __runInitializers(this, _width_initializers, null));
    };
})();
export { IconButton };
