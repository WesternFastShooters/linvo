import type { AdvancedPortalOptions, PortalOptions } from './types';
/**
 ...
 * ```
 */
export declare function createLitPortal({ computePosition: positionConfigOrFn, abortController, closeOnClickAway, positionStrategy, ...portalOptions }: AdvancedPortalOptions): HTMLDivElement;
