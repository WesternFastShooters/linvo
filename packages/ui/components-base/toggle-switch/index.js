...
let ToggleSwitch = (() => {
    ...
    `;
        ...
        accessor on = __runInitializers(this, _on_initializers, false);
        accessor onChange = (__runInitializers(this, _on_extraInitializers), __runInitializers(this, _onChange_initializers, undefined));
        constructor() {
            super(...arguments);
