...
let EditorIconButton = (() => {
    ...
    :host([active]) .icon-container.active-mode-border {
      border: 1px solid var(--linvo-brand-color);
    }
  ...
  `; }
      ...
      <style>
        ...
        .icon-container.hovered {
          background: ${this.hover ? `var(--linvo-hover-color)` : 'inherit'};
        }
      </style>
      <div
        class=${classnames}
      ...
      >
        ...
        ${cache(this.showTooltip && tooltip
                ...
                >${tooltip}</linvo-tooltip
              >`
                : nothing)}
      </div>
    `;
        }
        accessor active = __runInitializers(this, _active_initializers, false);
        accessor activeMode = (__runInitializers(this, _active_extraInitializers), __runInitializers(this, _activeMode_initializers, 'color'));
        accessor arrow = (__runInitializers(this, _activeMode_extraInitializers), __runInitializers(this, _arrow_initializers, true));
        accessor coming = (__runInitializers(this, _arrow_extraInitializers), __runInitializers(this, _coming_initializers, false));
        accessor disabled = (__runInitializers(this, _coming_extraInitializers), __runInitializers(this, _disabled_initializers, false));
        accessor hover = (__runInitializers(this, _disabled_extraInitializers), __runInitializers(this, _hover_initializers, true));
        accessor hoverState = (__runInitializers(this, _hover_extraInitializers), __runInitializers(this, _hoverState_initializers, false));
        accessor iconContainerPadding = (__runInitializers(this, _hoverState_extraInitializers), __runInitializers(this, _iconContainerPadding_initializers, 2));
        accessor iconContainerWidth = (__runInitializers(this, _iconContainerPadding_extraInitializers), __runInitializers(this, _iconContainerWidth_initializers, undefined));
        accessor iconContainerHeight = (__runInitializers(this, _iconContainerWidth_extraInitializers), __runInitializers(this, _iconContainerHeight_initializers, undefined));
        accessor iconSize = (__runInitializers(this, _iconContainerHeight_extraInitializers), __runInitializers(this, _iconSize_initializers, undefined));
        accessor justify = (__runInitializers(this, _iconSize_extraInitializers), __runInitializers(this, _justify_initializers, undefined));
        accessor labelHeight = (__runInitializers(this, _justify_extraInitializers), __runInitializers(this, _labelHeight_initializers, undefined));
        accessor showTooltip = (__runInitializers(this, _labelHeight_extraInitializers), __runInitializers(this, _showTooltip_initializers, true));
        accessor tipPosition = (__runInitializers(this, _showTooltip_extraInitializers), __runInitializers(this, _tipPosition_initializers, 'top'));
        accessor tooltip = (__runInitializers(this, _tipPosition_extraInitializers), __runInitializers(this, _tooltip_initializers, void 0));
        accessor tooltipOffset = (__runInitializers(this, _tooltip_extraInitializers), __runInitializers(this, _tooltipOffset_initializers, 8));
        accessor withHover = (__runInitializers(this, _tooltipOffset_extraInitializers), __runInitializers(this, _withHover_initializers, undefined));
    };
})();
