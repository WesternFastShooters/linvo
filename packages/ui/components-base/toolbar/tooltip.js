...
const triangleMap = {
    top: {
        ...
        borderColor: 'var(--linvo-tooltip) transparent transparent transparent',
    },
    right: {
        left: '-6px',
        borderStyle: 'solid',
        borderWidth: '5px 6px 5px 0',
        borderColor: 'transparent var(--linvo-tooltip) transparent transparent',
    },
    bottom: {
        top: '-6px',
        borderStyle: 'solid',
        borderWidth: '0 5px 6px 5px',
        borderColor: 'transparent transparent var(--linvo-tooltip) transparent',
    },
    left: {
        right: '-6px',
        borderStyle: 'solid',
        borderWidth: '5px 0 5px 6px',
        borderColor: 'transparent transparent transparent var(--linvo-tooltip)',
    },
};
  ...
  `; }
    ...
    `;
        ...
        constructor() {
            ...
            this.#zIndex_accessor_storage = (__runInitializers(this, _tooltipStyle_extraInitializers), __runInitializers(this, _zIndex_initializers, 'var(--linvo-z-index-popover)'));
