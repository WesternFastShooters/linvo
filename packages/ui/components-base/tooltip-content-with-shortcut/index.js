...
let TooltipContentWithShortcut = (() => {
  ...
  `; }
    ...
    `;
        ...
        accessor tip = __runInitializers(this, _tip_initializers, void 0);
        accessor shortcut = (__runInitializers(this, _tip_extraInitializers), __runInitializers(this, _shortcut_initializers, undefined));
        accessor postfix = (__runInitializers(this, _shortcut_extraInitializers), __runInitializers(this, _postfix_initializers, undefined));
        constructor() {
            super(...arguments);
...
export function effects() {
    defineCustomElement('linvo-tooltip-content-with-shortcut', TooltipContentWithShortcut);
}
