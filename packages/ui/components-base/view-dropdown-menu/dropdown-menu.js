...
import { ToolbarContext, } from '@linvo-core/shared/services';
import { SignalWatcher } from '@linvo-core/global/lit';
import { PropTypes, requiredProperties } from '@linvo-core/std';
...
let ViewDropdownMenu = (() => {
    ...
    var ViewDropdownMenu = class extends _classSuper {
        ...
        accessor actions = __runInitializers(this, _actions_initializers, void 0);
        accessor context = (__runInitializers(this, _actions_extraInitializers), __runInitializers(this, _context_initializers, void 0));
        accessor viewType$ = (__runInitializers(this, _context_extraInitializers), __runInitializers(this, _viewType$_initializers, void 0));
        render() {
