...
import { FontFamilyIcon } from '@linvo-ui/components/icons';
import {
  mountShapeTextEditor,
  SHAPE_OVERLAY_HEIGHT,
  SHAPE_OVERLAY_WIDTH,
  ShapeComponentConfig,
} from '@linvo-primitives/shape';
import {
...
export class EdgelessAutoCompletePanel extends WithDisposable(LitElement) {
  ...
  constructor(
    ...
    currentSource: ShapeElementModel,
  ...
  private _addFrame() {
    ...
    const props = this.std.get(EditPropsStore).applyLastProps('linvo:frame', {
      title: new PlainText(`Frame ${frameIndex}`),
  ...
  @property({ attribute: false })
  accessor currentSource: ShapeElementModel;
