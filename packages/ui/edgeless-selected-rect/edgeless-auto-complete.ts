...
import { ToolbarRegistryIdentifier } from '@linvo-core/shared/services';
import type { SelectedRect } from '@linvo-core/shared/types';
import { handleNativeRangeAtPoint } from '@linvo-core/shared/utils';
import { DisposableGroup } from '@linvo-core/global/disposable';
import type { Bound, IVec } from '@linvo-core/global/gfx';
import { Vec } from '@linvo-core/global/gfx';
...
export class EdgelessAutoComplete extends WithDisposable(LitElement) {
  static override styles = css`
    ...
    .edgeless-auto-complete-arrow-wrapper
      ...
      border: 1px solid var(--linvo-white-10);
      box-shadow: var(--linvo-shadow-1);
      background: var(--linvo-primary-color);
    }
  ...
  private _renderArrow() {
    ...
    // Auto-complete arrows for shape: right, bottom, left, top.
