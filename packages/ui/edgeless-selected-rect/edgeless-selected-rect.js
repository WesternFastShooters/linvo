...
import {} from '@linvo-primitives/frame';
import { EdgelessLegacySlotIdentifier, OverlayIdentifier, } from '@linvo-core/block-surface';
import { ConnectorElementModel, } from '@linvo-core/content';
import { unsafeCSSVarV2 } from '@linvo-core/shared/theme';
import { getSelectedRect, requestThrottledConnectedFrame, stopPropagation, } from '@linvo-core/shared/utils';
import { deserializeXYWH } from '@linvo-core/global/gfx';
import { WidgetComponent } from '@linvo-core/std';
import { GfxControllerIdentifier, InteractivityIdentifier, } from '@linvo-core/std/gfx';
import { css, html, nothing } from 'lit';
import { state } from 'lit/decorators.js';
import { ifDefined } from 'lit/directives/if-defined.js';
import { repeat } from 'lit/directives/repeat.js';
import { styleMap } from 'lit/directives/style-map.js';
import { RenderResizeHandles } from './resize-handles';
import { generateCursorUrl, getRotatedResizeCursor } from './utils';
export * from './utils';
...
let EdgelessSelectedRectWidget = (() => {
    ...
    .linvo-edgeless-selected-rect {
      ...
      z-index: 1;
      border-color: var(--linvo-blue);
      border-width: 2px;
      border-style: solid;
      transform: translate(0, 0) rotate(0);
    }

    .linvo-edgeless-selected-rect[data-locked='true'] {
      border-color: ${unsafeCSSVarV2('edgeless/lock/locked', '#00000085')};
    }

    .linvo-edgeless-selected-rect .handle {
      position: absolute;
      user-select: none;
      outline: none;
      pointer-events: auto;
    ...
    .linvo-edgeless-selected-rect .handle[aria-label^='top-'],
    .linvo-edgeless-selected-rect .handle[aria-label^='bottom-'] {
      width: 18px;
      height: 18px;
      box-sizing: border-box;
      z-index: 10;
    ...
    .linvo-edgeless-selected-rect .handle[aria-label^='top-'] .resize,
    .linvo-edgeless-selected-rect .handle[aria-label^='bottom-'] .resize {
      position: absolute;
      width: 12px;
      height: 12px;
      box-sizing: border-box;
      border-radius: 50%;
      border: 2px var(--linvo-blue) solid;
      background: white;
    }

    .linvo-edgeless-selected-rect .handle[aria-label^='top-'] .rotate,
    .linvo-edgeless-selected-rect .handle[aria-label^='bottom-'] .rotate {
      position: absolute;
      width: 12px;
      height: 12px;
      box-sizing: border-box;
    ...
    /* -18 + 6.5 */
    .linvo-edgeless-selected-rect .handle[aria-label='top-left'] {
      left: -12px;
      top: -12px;
    }
    .linvo-edgeless-selected-rect .handle[aria-label='top-left'] .resize {
      right: 0;
      bottom: 0;
    }
    .linvo-edgeless-selected-rect .handle[aria-label='top-left'] .rotate {
      right: 6px;
      bottom: 6px;
    }

    .linvo-edgeless-selected-rect .handle[aria-label='top-right'] {
      top: -12px;
      right: -12px;
    }
    .linvo-edgeless-selected-rect .handle[aria-label='top-right'] .resize {
      left: 0;
      bottom: 0;
    }
    .linvo-edgeless-selected-rect .handle[aria-label='top-right'] .rotate {
      left: 6px;
      bottom: 6px;
    }

    .linvo-edgeless-selected-rect .handle[aria-label='bottom-right'] {
      right: -12px;
      bottom: -12px;
    }
    .linvo-edgeless-selected-rect .handle[aria-label='bottom-right'] .resize {
      left: 0;
      top: 0;
    }
    .linvo-edgeless-selected-rect .handle[aria-label='bottom-right'] .rotate {
      left: 6px;
      top: 6px;
    }

    .linvo-edgeless-selected-rect .handle[aria-label='bottom-left'] {
      bottom: -12px;
      left: -12px;
    }
    .linvo-edgeless-selected-rect .handle[aria-label='bottom-left'] .resize {
      right: 0;
      top: 0;
    }
    .linvo-edgeless-selected-rect .handle[aria-label='bottom-left'] .rotate {
      right: 6px;
      top: 6px;
    }
    ...
    .linvo-edgeless-selected-rect .handle[aria-label='top'],
    .linvo-edgeless-selected-rect .handle[aria-label='bottom'],
    .linvo-edgeless-selected-rect .handle[aria-label='left'],
    .linvo-edgeless-selected-rect .handle[aria-label='right'] {
      border: 0;
      background: transparent;
      border-color: var('--linvo-blue');
    }
    ...
    .linvo-edgeless-selected-rect .handle[aria-label='top'] .resize,
    .linvo-edgeless-selected-rect .handle[aria-label='bottom'] .resize,
    .linvo-edgeless-selected-rect .handle[aria-label='left'] .resize,
    .linvo-edgeless-selected-rect .handle[aria-label='right'] .resize {
      width: 100%;
      height: 100%;
    }

    .linvo-edgeless-selected-rect .handle[aria-label='top'] .resize:after,
    .linvo-edgeless-selected-rect .handle[aria-label='bottom'] .resize:after,
    .linvo-edgeless-selected-rect .handle[aria-label='left'] .resize:after,
    .linvo-edgeless-selected-rect .handle[aria-label='right'] .resize:after {
      position: absolute;
      width: 7px;
      height: 7px;
      box-sizing: border-box;
    ...
    .linvo-edgeless-selected-rect .handle .resize::before {
      content: '';
      display: none;
      position: absolute;
      width: 20px;
    ...
    .linvo-edgeless-selected-rect[data-mode='scale']
      .handle[aria-label='top-left']
      .resize:hover::before,
    .linvo-edgeless-selected-rect[data-scale-direction='top-left'][data-scale-percent]
      .handle[aria-label='top-left']
      .resize::before {
      display: block;
      top: 0px;
    ...
    .linvo-edgeless-selected-rect[data-mode='scale']
      ...
      .resize:hover::before,
    .linvo-edgeless-selected-rect[data-scale-direction='top-right'][data-scale-percent]
      .handle[aria-label='top-right']
      .resize::before {
      display: block;
      top: 0px;
    ...
    .linvo-edgeless-selected-rect[data-mode='scale']
      ...
      .resize:hover::before,
    .linvo-edgeless-selected-rect[data-scale-direction='bottom-right'][data-scale-percent]
      .handle[aria-label='bottom-right']
      .resize::before {
      display: block;
      bottom: 0px;
    ...
    .linvo-edgeless-selected-rect[data-mode='scale']
      ...
      .resize:hover::before,
    .linvo-edgeless-selected-rect[data-scale-direction='bottom-left'][data-scale-percent]
      .handle[aria-label='bottom-left']
      .resize::before {
      display: block;
      bottom: 0px;
    ...
    .linvo-edgeless-selected-rect::after {
    ...
    .linvo-edgeless-selected-rect[data-scale-direction='top-left']::after {
      display: block;
      top: -20px;
      left: -20px;
      transform: translate(-100%, -100%);
    }
    .linvo-edgeless-selected-rect[data-scale-direction='top-right']::after {
      display: block;
      top: -20px;
      right: -20px;
      transform: translate(100%, -100%);
    }
    .linvo-edgeless-selected-rect[data-scale-direction='bottom-right']::after {
      display: block;
      bottom: -20px;
      right: -20px;
      transform: translate(100%, 100%);
    }
    .linvo-edgeless-selected-rect[data-scale-direction='bottom-left']::after {
      display: block;
      bottom: -20px;
      left: -20px;
      transform: translate(-100%, 100%);
  ...
  `; }
      ...
      `);
            ...
            if (elements.length > 1 &&
                ...
                handles.push(repeat(elements, element => element.id, element => {
                    ...
                    const style = {
                        ...
                        border: `1px solid var(--linvo-primary-color)`,
                    };
                    return html `<div
        ...
        render() {
            ...
            return html `
      <style>
        .linvo-edgeless-selected-rect .handle[aria-label='right']::after {
          content: '';
          ...
          width: 2px;
          height: 100%;
          background: var(--linvo-error-color);
          filter: drop-shadow(-6px 0px 12px rgba(235, 67, 53, 0.35));
        }

        .linvo-edgeless-selected-rect .handle[aria-label='bottom']::after {
          content: '';
      ...
      <div
        class="linvo-edgeless-selected-rect"
        style=${styleMap({
