import { EdgelessCRUDIdentifier, Overlay, } from '@linvo-core/block-surface';
import { ShapeFactory } from '@linvo-primitives/shape';
import { getShapeRadius, getShapeType, GroupElementModel, ShapeElementModel, } from '@linvo-core/content';
import { EditPropsStore } from '@linvo-core/shared/services';
import { LinvoError, ErrorCode } from '@linvo-core/global/exceptions';
import { Bound, normalizeDegAngle } from '@linvo-core/global/gfx';
...
export function createEdgelessElement(edgeless, current, bound) {
    ...
    if (!element) {
        throw new LinvoError(ErrorCode.GfxBlockElementError, 'Element is not found after creation');
    }
