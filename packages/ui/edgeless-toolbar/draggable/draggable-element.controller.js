import { EditPropsStore, ThemeProvider, ViewportElementProvider, } from '@linvo-core/shared/services';
import { Bound } from '@linvo-core/global/gfx';
import { GfxControllerIdentifier } from '@linvo-core/std/gfx';
import { render, } from 'lit';
import { mouseResolver, touchResolver, } from './event-resolver';
import { createShapeDraggingOverlay, defaultInfo, } from './overlay-factory';
import { defaultIsValidMove, } from './types';
export class EdgelessDraggableElementController {
    ...
    _updateOverlayScale(zoom) {
        ...
        const scale = (standardWidth * (scaleWithZoom ? zoom : 1)) /
