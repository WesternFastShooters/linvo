...
import { DefaultTool, EdgelessLegacySlotIdentifier, } from '@linvo-core/block-surface';
import { popMenu, popupTargetFromElement, } from '@linvo-ui/components/context-menu';
import { darkToolbarStyles, lightToolbarStyles, } from '@linvo-ui/components/toolbar';
...
import { ArrowLeftSmallIcon, ArrowRightSmallIcon, MoreHorizontalIcon, } from '@icons/lit';
...
import { QuickToolIdentifier, SeniorToolIdentifier, } from './extension';
...
let EdgelessToolbarWidget = (() => {
    ...
    .full-divider::after {
      ...
      width: 1px;
      height: 100%;
      background-color: var(--linvo-border-color);
    }
    .pen-and-eraser {
      display: flex;
      height: 100%;
      ...
      >
        ...
        >
          <smooth-corner
            ...
            .smooth=${0.7}
            .borderWidth=${1}
            .bgColor=${'var(--linvo-background-overlay-panel-color)'}
            .borderColor=${'var(--linvo-border-color)'}
...
export const edgelessToolbarWidget = WidgetViewExtension('linvo:root', EDGELESS_TOOLBAR_WIDGET, literal `${unsafeStatic(EDGELESS_TOOLBAR_WIDGET)}`);
