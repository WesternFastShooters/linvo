...
import {
  ...
  type LinvoFrameTitleWidget,
} from './linvo-frame-title-widget';
import type { LinvoFrameTitle } from './frame-title';
...
export class EdgelessFrameTitleEditor extends WithDisposable(
  ...
  override render() {
    ...
    const frameTitle =
      frameTitleWidget.querySelector<LinvoFrameTitle>('linvo-frame-title');
  ...
  accessor plainTextEditor: PlainTextEditor | null = null;
}
