...
import { parseStringToRgba } from '@linvo-ui/components/color-picker';
import { ColorScheme, FrameBlockModel, isTransparent, } from '@linvo-core/content';
...
import { PropTypes, requiredProperties, stdContext, } from '@linvo-core/std';
import { GfxControllerIdentifier } from '@linvo-core/std/gfx';
import { consume } from '@lit/context';
import { themeToVar } from '@theme/v2';
import { LitElement } from 'lit';
import { property, state } from 'lit/decorators.js';
import { mountFrameTitleEditor } from './mount-frame-title-editor';
import { frameTitleStyle, frameTitleStyleVars } from './styles';
export const LINVO_FRAME_TITLE = 'linvo-frame-title';
let LinvoFrameTitle = (() => {
    ...
    var LinvoFrameTitle = class extends _classSuper {
        ...
        static {
            ...
            LinvoFrameTitle = _classThis = _classDescriptor.value;
        ...
        connectedCallback() {
            ...
            _disposables.add(doc.slots.blockUpdated.subscribe(payload => {
                if ((payload.type === 'update' &&
                    ...
                    (payload.type === 'add' && payload.flavour === 'linvo:frame')) {
                    this._nestedFrame = this._isInsideFrame();
                }
            ...
            _disposables.add(() => {
                this.model.props.title.unobserve(updateTitle);
            });
            this.model.props.title.observe(updateTitle);
            this._frameTitle = this.model.props.title.toString().trim();
            this._xywh = this.model.xywh;
        }
        firstUpdated() {
    ...
    return LinvoFrameTitle = _classThis;
})();
export { LinvoFrameTitle };
