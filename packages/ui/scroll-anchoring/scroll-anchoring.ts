...
import { HighlightSelection } from '@linvo-core/shared/selection';
...
export const LINVO_SCROLL_ANCHORING_WIDGET = 'linvo-scroll-anchoring-widget';

export class LinvoScrollAnchoringWidget extends WidgetComponent {
  ...
  #moveToAnchorInEdgeless(id: string) {
    ...
    if (parentComponent && parentComponent.flavour === 'linvo:note') {
