import type { DeltaOperation } from '@linvo-core/store';
import { expect, type Page } from 'playwright/test';

import type { InlineEditor, InlineRange } from '@linvo-core/std/inline';
...
export async function getDeltaFromInlineRichText(
  ...
  return page.evaluate(index => {
    ...
    return editor.yText.toDelta() as unknown as DeltaOperation[];
  }, index);
}
