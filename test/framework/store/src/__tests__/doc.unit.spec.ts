...
test('query', () => {
  ...
  const page = store1.addBlock('linvo:root');
  const note = store1.addBlock('linvo:note', {}, page);
  const paragraph1 = store1.addBlock('linvo:item', {}, note);
  const list1 = store1.addBlock('linvo:group' as never, {}, note);
  ...
  const list2 = store1.addBlock('linvo:group' as never, {}, note);
