import { Container } from '@linvo-core/composition/di';
import { type ExtensionType } from '@linvo-core/store';
import { describe, expect, it, vi } from 'vitest';
import { z } from 'zod';

import { ExtensionManager } from '@linvo-core/composition';
import {
...
import { ViewExtensionManager } from '@linvo-core/composition';
import {
...
it('should be able to validate schema', () => {
  ...
  let viewExtensions = manager.get('preview');
  ...
  viewExtensions = manager.get('preview');
  expect(setupOption).toHaveBeenCalledWith(undefined);
});
